      ...
      <table class="table table-striped table-bordered table-hover" id="produk_tabungan">
         <thead>
            <tr>
               ...
               <th width="21%">GL Saldo</th>
               <th width="21%">GL Biaya</th>
               <th width="21%">GL Admin</th>
               <th>Edit</th>
            </tr>
         </thead>
         <tbody>
      ...
      <div class="portlet-body form">
         ...
         <form action="#" id="form_add" class="form-horizontal">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input type="text" name="product_saving_gl_code" id="product_saving_gl_code" data-required="1" class="medium m-wrap"  onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" maxlength="5" />
               </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <select name="gl_biaya" id="gl_biaya" class="large m-wrap" data-required="1">
                     <option value="">PILIH</option>
                     <?php
                     foreach ($gl_account as $data): 
                     ?>
         ...
         <form action="#" id="form_edit" class="form-horizontal">
          <input type="hidden" id="product_saving_gl_id" name="product_saving_gl_id">
            ...
            <div class="control-group">
               <label class="control-label">GL Saldo<span class="required">*</span></label>
               <div class="controls">
                  <select name="gl_saldo" id="gl_saldo2" class="large m-wrap" data-required="1">
                     <option value="">PILIH</option>
                     <?php
                     foreach ($gl_account as $data): 
                     ?>
            ...
            <div class="control-group">
               <label class="control-label">GL Biaya<span class="required">*</span></label>
               <div class="controls">
                  <select name="gl_biaya" id="gl_biaya2" class="large m-wrap" data-required="1">
                     <option value="">PILIH</option>
                     <?php
                     foreach ($gl_account as $data): 
                     ?>
            ...
            <div class="control-group">
               <label class="control-label">GL Admin<span class="required">*</span></label>
               <div class="controls">
                  <select name="gl_adm" id="gl_adm2" class="large m-wrap" data-required="1">
                     <option value="">PILIH</option>
                     <?php
                     foreach ($gl_account as $data): 
                     ?>
...
$(function(){
  ...
  $("#gl_saldo,#gl_biaya,#gl_adm","#form_add").chosen({
      allow_single_deselect: $(this).attr("data-with-diselect") === "1" ? true : false,
      search_contains: true
  });
  $("#gl_saldo2,#gl_biaya2,#gl_adm2","#form_edit").chosen({
      allow_single_deselect: $(this).attr("data-with-diselect") === "1" ? true : false,
      search_contains: true
  });
      ...
      $("#btn_add").click(function(){
        ...
        form1.trigger('reset');
        $("#rencana").hide();
        $("#gl_saldo,#gl_biaya,#gl_adm","#form_add").trigger('liszt:updated');
      });
      ...
      $("a#link-edit").live('click',function(){
        ...
        $.ajax({
          ...
          success: function(response)
          {
            ...
            $("#gl_saldo2, #form_edit").val(response.gl_saldo); 
            $("#gl_biaya2, #form_edit").val(response.gl_biaya); 
            $("#gl_adm2, #form_edit").val(response.gl_adm); 
            $("#gl_saldo2,#gl_biaya2,#gl_adm2","#form_edit").trigger('liszt:updated');
          }
        });
