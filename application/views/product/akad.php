      ...
      <table class="table table-striped table-bordered table-hover" id="produk_tabungan">
         <thead>
            <tr>
               ...
               <th width="29%">Jenis Keuntungan</th>
               <th>Edit</th>
            </tr>
         </thead>
         <tbody>
      ...
      <div class="portlet-body form">
         ...
         <form action="#" id="form_add" class="form-horizontal">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input type="text" name="akad_code" id="akad_code" data-required="1" class="medium m-wrap"  onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" maxlength="5" />
               </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <select name="jenis_keuntungan" id="jenis_keuntungan" class="large m-wrap" data-required="1">
                     <option value="">PILIH</option>
                     <option value="0">Tidak Ada Keuntungan</option>
