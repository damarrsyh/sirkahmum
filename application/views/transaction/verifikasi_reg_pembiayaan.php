...
<div class="portlet box blue" id="wrapper-table">
   ...
   <div class="portlet-body">
      ...
      <div class="clearfix" style="background:#EEE" id="form-filter">
        ...
        <div style="padding:5px;float:left;">
          <input id="param_tanggal_akad" name="param_tanggal_akad" class="mask_date date-picker mask_date" type="text" style="width:100px;padding:4px;margin-top:2px;margin-left:5px;margin-bottom:5px;box-shadow:0 0 0;" value="<?php echo date('d/m/Y',strtotime($trx_date)); ?>" maxlength="10" placeholder="dd/mm/yyyy" tabindex="2">
        </div>
        <div style="padding:5px;float:left;">
                   ...
                   <div class="control-group">
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                        ...
                        <input type="text" class=" medium m-wrap" name="p_no_hp" id="p_no_hp"  style="background-color:#eee;width:100px;"  readonly=""/>
                        <span class="help-inline"></span>
                      </div>
                    </div>
                  ...
                  <div id="nisbah2">     
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                           <div class="input-prepend input-append">
                             <span class="add-on">Rp</span>
                             <input type="text" class="m-wrap mask-money" style="background-color:#eee;width:120px;"  readonly="" name="dtk" id="dtk">
                             <span class="add-on">,00</span>
                           </div>
                         </div>
                    </div>
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
	                        <input type="text" class="m-wrap" style="background-color:#eee;"  readonly="" name="kreditur_code1" id="kreditur_code1">
                         </div>
                    </div> 
                    </div> 
                    <div id="kreditur2"> 
      ...
      $("a#link-edit").live('click',function(){
        ...
        $.ajax({
          ...
          success: function(response)
          {
            ...
            $("#form_edit input[name='dtk']").val(number_format(response.simpanan_wajib_pinjam,0,',','.'));
			...
			if(response.kreditur_code == '00'){
				kreditur_code = 'Dana Sendiri';
			} else {
				kreditur_code = '';
			}
            ...
            $("#form_edit input[name='dana_kreditur']").val(number_format(response.pokok,0,',','.'));
			      $("#form_edit input[name='kreditur_code1']").val(kreditur_code);
    ...
    $(function(){
      ...
      var success2 = $('.alert-success', form2);
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"transaction/verifikasi_rek_pembiayaan_new",
              dataType: "json",
  ...
  //  END FORM EDIT VALIDATION
      ...
      table=$('#rekening_pembiayaan_table').dataTable({
          ...
          "fnServerParams": function ( aoData ) {
              aoData.push( { "name": "param_tanggal_akad", "value": datepicker_replace($("#param_tanggal_akad").val()) } );
