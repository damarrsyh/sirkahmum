...
<div class="row-fluid">
   <div class="span12">
    ...
    <h3 class="page-title">
      Pembelian <small>Persediaan Murabahah</small>
    </h3>
    <ul class="breadcrumb">
      <li>
        <i class="icon-home"></i>
      ...
      <li><a href="#">Pembelian Persediaan Murabahah</a></li> 
    </ul>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Pembelian Persediaan Murabahah</div>
      <div class="tools">
   ...
   <div class="portlet-body">
      ...
      <p>
      <table class="table table-striped table-bordered table-hover" id="persediaan_mba_table">
         <thead>
            <tr>
               <!-- <th style="width:8px;"><input type="checkbox" class="group-checkable" data-set="#persediaan_mba_table .checkboxes" /></th> -->
               <th width="25%">No. Rekening</th>
               <th width="20%">Nama</th>
               <th width="20%">Pembiayaan</th>
               <th width="20%">Tanggal Akad</th>
...
<script type="text/javascript">
    ...
    $(function(){
      $("#persediaan_mba_table_length").parent().parent().hide();
    })
    ...
    {
      var tbl_id = 'persediaan_mba_table';
     ...
     $("#select").click(function(){
      ...
      // jQuery('#persediaan_mba_table .group-checkable').live('change',function () {
      ...
      // $("#persediaan_mba_table .checkboxes").livequery(function(){
      //   $(this).uniform();
      // });
...
//fungsi untuk menggenerate Nama Akad
  ...
  //  END FORM EDIT VALIDATION
      ...
      // begin first table
      table=$('#persediaan_mba_table').dataTable({
          "bDestroy":true,
          "bProcessing": true,
          "bServerSide": true,
          //"sAjaxSource": site_url+"transaction/datatable_rekening_ver_pembiayaan_setup",
		  "sAjaxSource": site_url+"transaction/datatable_persediaan_mba_setup",
