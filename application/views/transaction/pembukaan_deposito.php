...
<div class="row-fluid">
   <div class="span12">
    ...
    <h3 class="page-title">
      Transaction <small>Transaksi Pembukaan Deposito</small>
    </h3>
    <ul class="breadcrumb">
      <li>
        <i class="icon-home"></i>
      ...
      <li><a href="#">Transaksi Pembukaan Deposito</a></li> 
    </ul>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Pembukaan Deposito</div>
      <div class="tools">
   ...
   <div class="portlet-body">
      ...
      <table class="table table-striped table-bordered table-hover" id="pembukaan_deposito_table">
         <thead>
            <tr>
...
{
  var tbl_id = 'pembukaan_deposito_table';
    ...
    setTimeout(function(){
      ...
      $('#keyword',"#dialog_rembug").trigger(e);
        ...
        $("#keyword", "#dialog_rembug").keypress(function(e){
          if(e.which==13){
            ...
            $.ajax({
              type: "POST",
              url: site_url+"transaction/get_deposito_verified",
      ...
      form1.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              url: site_url+"transaction/get_transaksi_by_norek",
              type: "POST",
              dataType: "html",
              async:false,
          data: {account_deposit_no:$("#account_deposit_no",form1).val()},
              ...
              if(response=='1'){
                  ...
                  alert("Transaksi pembukaan deposito an. "+nama+" nomer rekening "+norek+" sudah pernah dilakukan. Transaksi dibatalkan");
              }else
              {                
                  $.ajax({
                    type: "POST",
                    url: site_url+"transaction/add_pembukaan_deposito",
                    dataType: "json",
      ...
      // begin first table
      $('#pembukaan_deposito_table').dataTable({
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": site_url+"transaction/datatable_pembukaan_deposito",
          "aoColumns": [
            null,
            null,
            null,
      ...
      jQuery('#pembukaan_deposito_table_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
      jQuery('#pembukaan_deposito_table_wrapper .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
