...
<div class="row-fluid">
   <div class="span12">
      ...
      <h3 class="form-section">
        Verifikasi <small>Setoran Anggota</small>
      </h3>
      <!-- END PAGE TITLE-->
   </div>
</div>
...
<div class="portlet-body form">
    <div class="alert alert-error hide">
      ...
      <p>&nbsp;</p>
        ...
        <table class="table table-striped table-bordered table-hover" id="r_verif_anggota">
          <thead>
            <tr>
              <th>No. CIF</th>
              <th>Nama</th>
...
$(function(){
  ...
  $('a#verif_anggota').live('click',function(){
	  var trx_id = $(this).attr('trx_id');
	  
	  $.ajax({
		  type: 'POST',
		  url: site_url+'/transaction/proses_verifikasi_anggota',
		  dataType: 'json',
		  data: {id:trx_id},
		  async: false,
		  success: function(berhasil){
			  var sukses = berhasil.sukses;
			  
			  if(sukses == true){
				  alert('Berhasil! Data berhasil diverifikasi');
			  } else {
				  alert('Gagal! Data sudah pernah diverifikasi');
			  }
			  dTreload();
		  },
		  error: function(){
  ...
  $('#r_verif_anggota').dataTable({
	  "bDestroy":true,
	  "bProcessing": true,
	  "bServerSide": true,
	  "sAjaxSource": site_url+"transaction/datatable_r_verif_anggota",
