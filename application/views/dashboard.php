	...
	<div class="row-fluid">
		...
		<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
			<div class="dashboard-stat red">
				...
				<div class="details">
					<div class="number"><?php echo $branch['num']; ?></div>
					<div class="desc">
						Cabang
					</div>
				</div>
				<a class="more" href="#">
					Detail Cabang <i class="m-icon-swapright m-icon-white"></i>
				</a>
			</div>
		</div>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="span4 responsive" data-tablet="span4 fix-offset" data-desktop="span4">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="icon-group"></i> REKRUTMEN ANGGOTA </div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
						</div>
				...
				<div class="span4 responsive" data-tablet="span4 fix-offset" data-desktop="span4">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="icon-group"></i> ANGGOTA KELUAR </div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
						</div>
				...
				<div class="span4 responsive" data-tablet="span4 fix-offset" data-desktop="span4">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="icon-group"></i> JUMLAH ANGGOTA </div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
						</div>
			...
			<div class="row-fluid">
				<div class="span4 responsive" data-tablet="span4 fix-offset" data-desktop="span4">
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption"><i class="icon-money"></i> DISBURSEMENT </div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
						</div>
				...
				<div class="span4 responsive" data-tablet="span4 fix-offset" data-desktop="span4">
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption"><i class="icon-money"></i> OUTSTANDING </div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
						</div>
				...
				<div class="span4 responsive" data-tablet="span4 fix-offset" data-desktop="span4">
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption"><i class="icon-book"></i> PORTOFOLIO AT RISK </div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
						</div>
...
<script>
	...
	function getrekagtvs() {
		google.charts.load('current', {
			'packages': ['corechart', 'bar']
		});
		google.charts.setOnLoadCallback(drawChartrekagtvs);

		function drawChartrekagtvs() {
			let jsonData = $.ajax({
					url: '<?= site_url(); ?>dashboard/get_rekagt_vs',
					method: 'get',
					dataType: 'json',
					beforeSend: function() {
				...
				.done(function(res) {
					...
					let warna = [ '#8775a7', '#4B77BE', '#578ebe', '#1bbc9b', '#e08283', '#e87e04', '#8775a7', '#2f353b', '#4B77BE', '#578ebe', '#1bbc9b','#e08283', '#e87e04', '#2f353b' ];
					let no = 0;
					$.each(res, function(i, k) {
						let product_code = k.product_code;
						let product_name = k.product_name;
					...
					var chart = new google.visualization.ColumnChart(document.getElementById('vrekagtvs'));
					chart.draw(dataTable, options);
				});
		}
	} 

	function getoutagtvs() {
		google.charts.load('current', {
			'packages': ['corechart', 'bar']
		});
		google.charts.setOnLoadCallback(drawChartoutagtvs);

		function drawChartoutagtvs() {
			let jsonData = $.ajax({
					url: '<?= site_url(); ?>dashboard/get_outagt_vs',
					method: 'get',
					dataType: 'json',
					beforeSend: function() {
				...
				.done(function(res) {
					...
					var chart = new google.visualization.ColumnChart(document.getElementById('voutagtvs'));
					chart.draw(dataTable, options);
				});
		}
	} 

	function getjmlagtvs() {
		google.charts.load('current', {
			'packages': ['corechart', 'bar']
		});
		google.charts.setOnLoadCallback(drawChartjmlagtvs);

		function drawChartjmlagtvs() {
			let jsonData = $.ajax({
					url: '<?= site_url(); ?>dashboard/get_jmlagt_vs',
					method: 'get',
					dataType: 'json',
					beforeSend: function() {
				...
				.done(function(res) {
					...
					var chart = new google.visualization.ColumnChart(document.getElementById('vjmlagtvs'));
					chart.draw(dataTable, options);
				});
		}
	} 
	...
	function getparvs() {
		...
		google.charts.setOnLoadCallback(drawChartparvs);

		function drawChartparvs() {
			let jsonData = $.ajax({
					url: '<?= site_url(); ?>dashboard/get_par_vs',
					method: 'get',
					dataType: 'json',
					beforeSend: function() {
				...
				.done(function(res) {
					...
					var chart = new google.visualization.ColumnChart(document.getElementById('vparvs'));
					chart.draw(dataTable, options);
				});
		}
	}
