...
<div class="row-fluid">
   <div class="span12">
      ...
      <h3 class="form-section">
        KOREKSI TRANSAKSI MAJELIS <small></small>
      </h3>
      <!-- END PAGE TITLE-->
   </div>
</div>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Koreksi Transaksi Majelis</div>
      <div class="tools">
         ...
         <form action="javascript:;" method="post">
            ...
            <table id="filter-form">
               ...
               <tr id="field_rembug">
                  ...
                  <td>
                    <input type="hidden" name="cm_code" id="cm_code" value="00000">
                     <input type="text" name="rembug" id="rembug" class="m-wrap medium" readonly="" style="background:#eee;" value="Semua Rembug"> 
               ...
               <tr>
                  ...
                  <td><input type="text" name="from" id="from" class="mask_date date-picker" readonly="readonly" style="width:88px;background:#eee;padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;"> s.d <input type="text" name="thru" id="thru" class="mask_date date-picker" readonly="readonly" style="width:88px;background:#eee;padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;"></td>
               </tr>
               <tr>
                  <td></td>
                  <td>
                     <button class="green btn" id="showgrid">Tampilkan</button>
                     <button class="green btn" id="hapus">Hapus</button>
                  </td>
               </tr>
            </table>
         </form>
...
var gridaja = function(){
	jQuery("#list485").jqGrid({
		url: site_url+'koreksi/jqgrid_list_koreksi_tmajelis',
		datatype: 'json',
		height: 'auto',
		autowidth: true,
		postData: {
		...
		colNames:['Tanggal','Cabang','Majelis','Jurnal Transaksi','Petugas'],
		colModel:[
		  {name:'trx_date',index:'trx_date'},
		  {name:'branch_name',index:'branch_name'},
		  {name:'cm_name',index:'cm_name'},
		  {name:'jurnal_transaksi',index:'jurnal_transaksi'},
...
$('#hapus').click(function(){
	...
	$.ajax({
		type: 'POST',
		url: site_url+'koreksi/proses_koreksi_tmajelis',
		dataType: 'json',
		data: {
			branch_code:branch,
			cm_code:rembug,
...
/* BEGIN DIALOG ACTION BRANCH */
   ...
   $("#browse_rembug").click(function(){
      $.ajax({
         ...
         success: function(response){
            html = '<option value="00000" cm_id="" cm_name="Semua Rembug">00000 - SEMUA REMBUG</option>';
            for ( i = 0 ; i < response.length ; i++ )
            {
