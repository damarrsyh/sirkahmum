...
<div class="row-fluid">
   <div class="span12">
      ...
      <h3 class="form-section">
        KOREKSI JTO INDIVIDU <small></small>
      </h3>
      <!-- END PAGE TITLE-->
   </div>
</div>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Koreksi Jto Individu</div>
      <div class="tools">
         ...
         <form action="javascript:;" method="post">
            ...
            <table id="filter-form">
               ...
               <tr>
                  <td></td>
                  <td>
                    <button class="green btn" id="koreksix1" type="button">Proses</button>
                  </td>
               </tr>
            </table>
         </form>
...
$('#koreksix1').click(function(){
	...
	$.ajax({
		type: 'POST',
		url: site_url+'koreksi/proses_koreksi_jto_individu',
		dataType: 'json',
		data: {branch:branch},
