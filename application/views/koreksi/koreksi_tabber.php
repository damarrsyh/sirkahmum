...
<div class="row-fluid">
   <div class="span12">
      ...
      <h3 class="form-section">
        KOREKSI TABUNGAN BERENCANA <small></small>
      </h3>
      <!-- END PAGE TITLE-->
   </div>
</div>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Koreksi Tabungan Berencana</div>
      <div class="tools">
...
var gridaja = function(){
	jQuery("#list485").jqGrid({
		url: site_url+'koreksi/jqgrid_list_koreksi_tabber',
		datatype: 'json',
		height: 'auto',
		autowidth: true,
		postData: {
		...
		colNames:['No. Rekening','Nama','Saldo Memo','Saldo Histori','Rembug'],
		colModel:[
		  {name:'account_saving_no',index:'account_saving_no'},
		  {name:'nama',index:'nama'},
		  {name:'saldo_memo',index:'saldo_memo'},
		  {name:'saldo_histori',index:'saldo_histori'},
...
$('#koreksi').click(function(){
	...
	$.ajax({
		type: 'POST',
		url: site_url+'koreksi/proses_koreksi_tabber',
		dataType: 'json',
