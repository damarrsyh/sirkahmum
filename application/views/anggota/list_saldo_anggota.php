...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Saldo Anggota</div>
      <div class="tools">
  ...
  if (filter=="5") {
    ...
    $('#kecamatan').hide().val('');
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        if (filter=='5'){
          window.open('<?php echo site_url();?>laporan/export_pdf_saldo_anggota_kecamatan/'+tanggal+'/'+tanggal2+'/'+cabang+'/'+kecamatan);
        }else{
      ...
      $("#previewxls").click(function(e)
      {
        ...
        var filter = $("#filter").val();
        if (filter=='5'){
          window.open('<?php echo site_url();?>laporan/export_xls_saldo_anggota_kecamatan/'+tanggal+'/'+tanggal2+'/'+cabang+'/'+kecamatan);
        }else{
          alert("Parameter Kosong");
        }
      });
