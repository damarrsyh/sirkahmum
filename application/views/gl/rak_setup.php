...
<div class="row-fluid">
   <div class="span12">
    ...
    <h3 class="page-title">
      RAK Setup <small>Setup GL RAK</small>
    </h3>
    <ul class="breadcrumb">
      <li>
        <i class="icon-home"></i>
        ...
        <i class="icon-angle-right"></i>
         ...
         <li><a href="#">RAK Setup</a><i class="icon-angle-right"></i></li>  
      <li><a href="#">Setup GL RAK</a></li> 
    </ul>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Setup GL RAK</div>
      <div class="tools">
   ...
   <div class="portlet-body">
      ...
      <table class="table table-striped table-bordered table-hover" id="rak_table">
         <thead>
            <tr>
               <th width="1%"><input type="checkbox" class="group-checkable" data-set="#rak_table .checkboxes" /></th>
               <th>Cabang</th>
               <th>GL RAK</th>
               <th>GL Bank Transfer</th>
               <th>GL Biaya RAK</th>
               <th>GL Pendapatan RAK</th>
               <th width="5%">Edit</th>
            </tr>
         </thead>
         <tbody>
...
<div id="add" class="hide">
   ...
   <div class="portlet box green">
      <div class="portlet-title">
         <div class="caption"><i class="icon-reorder"></i>Setup RAK</div>
         <div class="tools">
            <a href="javascript:;" class="collapse"></a>
         </div>
      </div>
      <div class="portlet-body form">
         ...
         <form action="#" id="form_add" class="form-horizontal">
            ...
            <div class="alert alert-success hide">
               <button class="close" data-dismiss="alert"></button>
               Setup RAK Berhasil Diproses !
            </div>      
                    <div class="control-group">
                       <label class="control-label">Cabang<span class="required">*</span></label>
                       <div class="controls">
                         <select name="branch_code" id="branch_code" class="chosen" style="width:400px;">                     
                    ...
                    <div class="control-group">
                       <label class="control-label">GL RAK Account<span class="required">*</span></label>
                       <div class="controls">
                         <select name="rak_account_code" id="rak_account_code" class="chosen" style="width:400px;">                     
                            <option value="">PILIH</option>
                    ...
                    <div class="control-group">
                       <label class="control-label">GL Bank Account<span class="required">*</span></label>
                       <div class="controls">
                         <select name="bank_account_code" id="bank_account_code" class="chosen" style="width:400px;">                     
                            <option value="">PILIH</option>
                            <?php foreach($account_name as $data): ?>
                              <option value="<?php echo $data['account_code'];?>"><?php echo $data['account_name'];?></option>
                            <?php endforeach?>
                    ...
                    <div class="control-group">
                       <label class="control-label">GL Biaya Account<span class="required">*</span></label>
                       <div class="controls">
                         <select name="biaya_account_code" id="biaya_account_code" class="chosen" style="width:400px;">                     
                            <option value="">PILIH</option>
                            <?php foreach($account_name as $data): ?>
                              <option value="<?php echo $data['account_code'];?>"><?php echo $data['account_name'];?></option>
                            <?php endforeach?>
                    ...
                    <div class="control-group">
                       <label class="control-label">GL Pendapatan Account<span class="required">*</span></label>
                       <div class="controls">
                         <select name="pendapatan_account_code" id="pendapatan_account_code" class="chosen" style="width:400px;">                     
                            <option value="">PILIH</option>
                            <?php foreach($account_name as $data): ?>
                              <option value="<?php echo $data['account_code'];?>"><?php echo $data['account_name'];?></option>
                            <?php endforeach?>
               ...
               <form action="#" id="form_edit" class="form-horizontal">
                  ...
                  <br>  
                    <div class="control-group">
                       <label class="control-label">Cabang<span class="required">*</span></label>
                       <div class="controls">
                         <select name="branch_code" id="branch_code2" class="chosen" style="width:400px;">                     
                            <option value="">PILIH</option>
                            <?php foreach($branch as $data): ?>
                              <option value="<?php echo $data['branch_code'];?>"><?php echo $data['branch_name'];?></option>
                            <?php endforeach?>
                    ...
                    <div class="control-group">
                       <label class="control-label">GL RAK Account<span class="required">*</span></label>
                       <div class="controls">
                         <select name="rak_account_code" id="rak_account_code2" class="chosen" style="width:400px;">                     
                            <option value="">PILIH</option>
                            <?php foreach($account_name as $data): ?>
                              <option value="<?php echo $data['account_code'];?>"><?php echo $data['account_name'];?></option>
                            <?php endforeach?>
                    ...
                    <div class="control-group">
                       <label class="control-label">GL Bank Account<span class="required">*</span></label>
                       <div class="controls">
                         <select name="bank_account_code" id="bank_account_code2" class="chosen" style="width:400px;">                     
                            <option value="">PILIH</option>
                            <?php foreach($account_name as $data): ?>
                              <option value="<?php echo $data['account_code'];?>"><?php echo $data['account_name'];?></option>
                            <?php endforeach?>
                    ...
                    <div class="control-group">
                       <label class="control-label">GL Biaya Account<span class="required">*</span></label>
                       <div class="controls">
                         <select name="biaya_account_code" id="biaya_account_code2" class="chosen" style="width:400px;">                     
                            <option value="">PILIH</option>
                            <?php foreach($account_name as $data): ?>
                              <option value="<?php echo $data['account_code'];?>"><?php echo $data['account_name'];?></option>
                            <?php endforeach?>
                    ...
                    <div class="control-group">
                       <label class="control-label">GL Pendapatan Account<span class="required">*</span></label>
                       <div class="controls">
                         <select name="pendapatan_account_code" id="pendapatan_account_code2" class="chosen" style="width:400px;">                     
                            <option value="">PILIH</option>
                            <?php foreach($account_name as $data): ?>
                              <option value="<?php echo $data['account_code'];?>"><?php echo $data['account_name'];?></option>
                            <?php endforeach?>
...
$(function(){
      ...
      form1.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"gl/proses_input_setup_rak",
              dataType: "json",
      ...
      $("a#link-edit").live('click',function(){
        ...
        $.ajax({
          ...
          dataType: "json",
          data: {rak_id:rak_id},
          url: site_url+"gl/get_gl_rak_by_id",
          success: function(response){
            console.log(response);
            $('#rak_id').val(response.rak_id);
			$('#branch_code2').val(response.branch_code).trigger('liszt:updated');
			$('#rak_account_code2').val(response.rak_account_code).trigger('liszt:updated');
			$('#bank_account_code2').val(response.bank_account_code).trigger('liszt:updated');
			$('#biaya_account_code2').val(response.biaya_account_code).trigger('liszt:updated');
			$('#pendapatan_account_code2').val(response.pendapatan_account_code).trigger('liszt:updated');
          }
        })
      ...
      form2.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"gl/proses_edit_setup_rak",
              dataType: "json",
      ...
      $('#rak_table').dataTable({
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": site_url+"gl/datatable_setup_rak",
          "aoColumns": [
            null,
            null,
            null,
      ...
      jQuery('#rak_table_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
      jQuery('#rak_table_wrapper .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
