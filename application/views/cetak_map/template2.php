...
<page orientation="portrait" style="font-size: 16px" backtop="0mm" backbottom="0mm" backleft="10mm" backright="10mm">
        ...
        <tr>
            <td style="width: 49%; vertical-align: top;">
                <table cellspacing="0" style="width: 100%; border: solid 1px #dee2e6; vertical-align: top;">
                    ...
                    <tr>
                        <td style="width: 43%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">Rembug</td>
                        <td style="width: 3%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px; text-align: center;">:</td>
                        <td style="width: 54%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;"><?= $rembug; ?></td>
                    </tr>
                </table>
            </td>
            <td style="width: 2%;">
    ...
    <table cellspacing="0" style="width: 100%; border-collapse: collapse; vertical-align: top; margin-top: 15px;" align="center">
        ...
        <tr>
            ...
            <td style="width: 33.33%; height: 60px; vertical-align: top; text-align: center; border-left: solid 1px #000; border-top: solid 1px #000; border-right: solid 1px #000; padding: 0px;">
                <?php
                if ($ttd_ketua_majelis != NULL) {
                    echo '<img src="' . $ttd_ketua_majelis . '" style="width:150px; vertical-align: middle; text-align: center;" />';
                }
                ?>
            </td>
            ...
            <td style="width: 33.33%; height: 60px; vertical-align: top; text-align: center; border-left: solid 1px #000; border-top: solid 1px #000; border-right: solid 1px #000; padding: 0px;">
                <?php
                if ($ttd_tpl != NULL) {
                    echo '<img src="' . $ttd_tpl . '" style="width:150px; vertical-align: middle; text-align: center;" />';
                }
                ?>
            </td>
...
<page orientation="portrait" style="font-size: 16px" backtop="10mm" backbottom="0mm" backleft="10mm" backright="10mm">
    <h4 style="text-align: center; margin-top: 20px; margin-bottom: 10px;">Profile Anggota Dan Majelis</h4>
    <table cellspacing="0" style="width: 100%; border-collapse: collapse; vertical-align: top;" align="center">
        <tr>
            <td style="width: 49%; vertical-align: top;">
                <table cellspacing="0" style="width: 100%; border: solid 1px #dee2e6; vertical-align: top;">
                    <tr style="border: solid 1px #dee2e6;">
                        <td colspan="3" style="width: 100%; font-size: 9pt; border: solid 1px #dee2e6;">
                            <strong>PRESTASI ANGGOTA</strong>
                        </td>
                    </tr>
                    <tr style="border: solid 1px #dee2e6;">
                        <td style="width: 43%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                    ...
                    <tr>
                        ...
                        <td style="width: 3%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px; text-align: center;">:</td>
                        <td style="width: 54%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                            <?= $prestasi_angsuran; ?> Angsuran
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 43%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                            Prestasi Kehadiran Anggota
                        </td>
                        <td style="width: 3%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px; text-align: center;">:</td>
                        <td style="width: 54%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                            <?= $prestasi_kehadiran_anggota; ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 43%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                        ...
                        <td style="width: 3%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px; text-align: center;">:</td>
                        <td style="width: 54%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px; vertical-align: top;">
                            <ul style="margin-top: -10px; margin-left: -15px;">
                                <li>
                                    Total Setoran <br> Rp. <?= $total_setoran; ?> <br /> (<?= $count_total_setoran; ?> Transaksi)
                                </li>
                                <li>
                                    Total Penarikan <br> Rp. <?= $total_penarikan; ?> <br /> (<?= $count_total_penarikan; ?> Transaksi)
                                </li>
                                <li>
                                    Rataan Setoran <br> Rp. <?= $rataan_setoran; ?>
                                    <!-- <br /> (<?= $count_rataan_setoran; ?> Transaksi) -->
                                </li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 54%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                            <ul style="margin-top: -10px; margin-left: -15px;">
                                <li>
                                    Tabungan Sukarela <br> Rp. <?= $tabungan_sukarela; ?>
                                </li>
                                <?php
                                if ($taber) {
                                ?>
                    ...
                    <tr>
                        <td style="width: 43%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                            Pernah Ditanggung Renteng
                        </td>
                        <td style="width: 3%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px; text-align: center;">:</td>
                        <td style="width: 54%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                            <?= $pernah_tanggung_renteng; ?>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="width: 49%; vertical-align: top;">
                <table cellspacing="0" style="width: 100%; border: solid 1px #dee2e6; vertical-align: top;">
                    <tr style="border: solid 1px #dee2e6;">
                        <td colspan="3" style="width: 43%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                            <strong>KONDISI MAJELIS</strong>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 43%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                    ...
                    <tr>
                        <td style="width: 43%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                            Rataan Kehadiran Majelis
                        </td>
                        <td style="width: 3%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px; text-align: center;">:</td>
                        <td style="width: 54%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
                            <?= $rataan_kehadiran_majelis; ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 43%; font-size: 9pt; border: solid 1px #dee2e6; padding: 4px;">
