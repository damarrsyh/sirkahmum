            ...
            <div class="form-wizard">
               ...
               <div class="tab-content">
                  <div class="tab-pane active" id="tab1">
                     ...
                     <div class="control-group">
                        <label class="control-label">LWK / Simpok <span class="required">*</span></label>
                        <div class="controls">
                  ...
                  <div class="tab-pane" id="tab2">
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                           <input type="text" class="small m-wrap date-picker-tgl-lahir" name="step2_pribadi_tgl_lahir" id="mask_date" />
                           &nbsp;
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                           <input type="text" class=" m-wrap" name="step2_pribadi_no_ktp" id="step2_pribadi_no_ktp" required="required" />
                           <span class="help-inline"></span>
                        </div>
                     </div>
                     <div class="control-group">
                        ...
                        <div class="controls">
                           <input type="text" class=" m-wrap" name="step2_pribadi_no_hp" id="step2_pribadi_no_hp" />
                           <span class="help-inline"></span>
                        </div>
                     </div>
                     <div class="control-group">
                        ...
                        <div class="controls">
                           <select name="step2_pribadi_pengguna_dana" id="step2_pribadi_pengguna_dana">
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                           <input type="text" class="small m-wrap date-picker-tgl-lahir" name="step2_pasangan_tglahir" id="mask_date" />
                           &nbsp;
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                           <input type="text" class=" m-wrap" name="step2_pasangan_no_ktp" id="step2_pasangan_no_ktp" />
                           <span class="help-inline"></span>
                        </div>
                     </div>
                     <div class="control-group">
                        <label class="control-label">No.Telp/HP</label>
                        <div class="controls">
                           <input type="text" class=" m-wrap" name="step2_pasangan_no_hp" id="step2_pasangan_no_hp" />
                           <span class="help-inline"></span>
                        </div>
                     </div>
                     <div class="control-group">
                  ...
                  <div class="tab-pane" id="tab3">
                     ...
                     <div class="control-group">
                        <label class="control-label">No. Rekening Listrik</label>
                        <div class="controls">
                           <input type="text" name="step3_rekening_listrik" id="step3_rekening_listrik" class="m-wrap">
                           &nbsp;
                           <div class="input-prepend input-append">
                           <span class="add-on">Bayar Perbulan</span>
                           <input type="text" class="m-wrap mask-money" name="step3_rekening_listrik_biaya" id="step3_rekening_listrik_biaya" maxlength="10" value="0">
                           <span class="add-on">,00</span>
                           </div>
                        </div>
                     </div>
                     <div class="control-group">
                        <label class="control-label">No. Rekening PDAM</label>
                        <div class="controls">
                           <input type="text" name="step3_rekening_pdam" id="step3_rekening_pdam" class="m-wrap">
                           &nbsp;
                           <div class="input-prepend input-append">
                           <span class="add-on">Bayar Perbulan</span>
                           <input type="text" class="m-wrap mask-money" name="step3_rekening_pdam_biaya" id="step3_rekening_pdam_biaya" maxlength="10" value="0">
                           <span class="add-on">,00</span>
                           </div>
                        </div>
                     </div>
                     <div class="control-group">
                        ...
                        <div class="controls">
                           <input type="text" name="step3_bpjs" id="step3_bpjs" class="m-wrap">
                           &nbsp;
                           <div class="input-prepend input-append">
                           <span class="add-on">Bayar Perbulan</span>
                           <input type="text" class="m-wrap mask-money" name="step3_bpjs_biaya" id="step3_bpjs_biaya" maxlength="10" value="0">
                           <span class="add-on">,00</span>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                           <select id="step3_rmhair" name="step3_rmhair">
                             ...
                             <option value="3">PDAM/PAMSIMAS</option>
                           </select>
                        </div>
                     </div>
                     <h3>Lahan</h3>
                  ...
                  <div class="tab-pane" id="tab4">
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                           ...
                           <span class="help-inline">liter perpekan</span>
                        </div>
                     </div>
                     <div class="control-group">
                        ...
                        <div class="controls">
                           ...
                           <span class="help-inline">perpekan</span>
                        </div>
                     </div>
                     <div class="control-group">
               ...
               <div class="form-actions clearfix">
                  ...
                  <a href="javascript:;" class="btn button-first cancel hide">
                     <i class="m-icon-swapleft"></i> First
                  </a>
            ...
            <div class="form-wizard">
               ...
               <div class="tab-content">
                  <div class="tab-pane active" id="etab1">
                     ...
                     <div class="control-group">
                        <label class="control-label">LWK / Simpok</label>
                        <div class="controls">
                           <div class="input-prepend input-append">
                             <span class="add-on">Rp</span>
                  ...
                  <div class="tab-pane" id="etab3">
                     ...
                     <div class="control-group">
                        <label class="control-label">No. Rekening PADM</label>
                        <div class="controls">
                           <input type="text" name="step3_rekening_pdam" id="step3_rekening_pdam" class="m-wrap">
                           &nbsp;
                           <div class="input-prepend input-append">
...
$(function(){
   /*
   | Validasi Usia Pribadi
   | ADD
   */
   jQuery.validator.addMethod("add_pribadi_validate_usia", function(value, element) {
      if(value==""){
        return false;
      }else{
   ...
   */
   jQuery.validator.addMethod("add_pasangan_validate_usia", function(value, element) {
      if(value==""){
        return true;
      }else{
        if(parseFloat(value)<10){
   ...
   | EDIT
   */
   jQuery.validator.addMethod("edit_pribadi_validate_usia", function(value, element) {
      if(value==""){
        return false;
      }else{
        if(parseFloat(value)<10){
   ...
   | Validasi Usia Pasangan
   */
   jQuery.validator.addMethod("edit_pasangan_validate_usia", function(value, element) {
      if(value==""){
        return true;
      }else{
        if(parseFloat(value)<10){
      ...
      $("select[name='branch']","#dialog_rembug").change(function(){
         ...
         branch_code = $("#branch_code","#dialog_rembug").val();
         $.ajax({
            type: "POST",
      ...
      $('#wizard_add_participant').bootstrapWizard({
          ...
          onNext: function (tab, navigation, index) {
              ...
              if($(tabelement).find('input,textarea,select',"#wizard_add_participant").valid()==0){
      ...
      $('#wizard_edit_participant').bootstrapWizard({
          ...
          onNext: function (tab, navigation, index) {
              tabelement = tab.find('a').attr('href');
              if($(tabelement).find('input,textarea,select',"#wizard_edit_participant").valid()==0){
               alert("You have some form errors. Please check again!");
               return false;
              }
              var total = navigation.find('li').length;
      ...
      | ADD
      */
      $("input[name='step2_pribadi_tgl_lahir']","#form_add").keyup(function(e){
         $("input[name='step2_pribadi_tgl_lahir']","#form_add").trigger('change');
      });

      $("input[name='step2_pribadi_tgl_lahir']","#form_add").change(function(){
         ...
         if(date.length==8){
            ...
            $.ajax({
               ...
               data: {date:date},
               success:function(response){
                  $("#step2_pribadi_usia","#form_add").val(response.age);
               }
            })
         }else{
            $("#step2_pribadi_usia","#form_add").val('');
         }
      });

      $("input[name='step2_pasangan_tglahir']","#form_add").keyup(function(e){
         $("input[name='step2_pasangan_tglahir']","#form_add").trigger('change');
      });
      $("input[name='step2_pasangan_tglahir']","#form_add").live('change',function(){
         date = $(this).val().replace(/\//g,'');
         date = date.replace(/\_/g,'');
         if(date.length==8){
            day = date.substring(0,2);
            ...
            $.ajax({
               ...
               data: {date:date},
               success:function(response){
                  $("#step2_pasangan_usia","#form_add").val(response.age);
               }
            });
         }else{
            $("#step2_pasangan_usia","#form_add").val('');
         }
      });
      /*
      | EDIT
      */
      $("input[name='step2_pribadi_tgl_lahir']","#form_edit").keyup(function(e){
         $("input[name='step2_pribadi_tgl_lahir']","#form_edit").trigger('change');
      });

      $("input[name='step2_pribadi_tgl_lahir']","#form_edit").change(function(){
         date = $(this).val().replace(/\//g,'');
         date = date.replace(/\_/g,'');
         if(date.length==8){
            console.log(date);
            ...
            $.ajax({
               ...
               data: {date:date},
               success:function(response){
                  $("#step2_pribadi_usia","#form_edit").val(response.age);
               }
            })
         }else{
            $("#step2_pribadi_usia","#form_edit").val('');
         }
      });

      $("input[name='step2_pasangan_tglahir']","#form_edit").keyup(function(e){
         $("input[name='step2_pasangan_tglahir']","#form_edit").trigger('change');
      });
      $("input[name='step2_pasangan_tglahir']","#form_edit").live('change',function(){
         date = $(this).val().replace(/\//g,'');
         date = date.replace(/\_/g,'');
         if(date.length==8){
            day = date.substring(0,2);
            ...
            $.ajax({
               ...
               data: {date:date},
               success:function(response){
                  $("#step2_pasangan_usia","#form_edit").val(response.age);
               }
            });
         }else{
            $("#step2_pasangan_usia","#form_edit").val('');
         }
      });
     ...
     $('#step2_pribadi_no_ktp',form1).blur(function(){
        var ktp = $(this).val();
        
        $.ajax({
           type: 'POST',
           url: site_url+'cif/cek_ktp',
           data: {ktp:ktp},
           dataType: 'json',
           success: function(response){
              var nama = response.nama;
              var no_ktp = response.no_ktp;
              var total = response.total;
              if(total > 0){
                 alert('No. KTP '+no_ktp+' sudah terdaftar sebagai anggota KSP MUM. silahkan cek di menu >Cek KTP Anggota< ');
                 window.location = site_url+'cif/cif_kelompok';
              }
           }
        });
     });

     $('#step2_pribadi_no_ktp','#form_edit').blur(function(){
        var ktp = $(this).val();
      ...
      $("#btn_add").click(function(){
         if($("#cm_code").val()!=""){
            ...
            $("li.span3",form1).removeClass('done');
            $("#tab-content",form1).children('div.tab-pane').removeClass('active');
            $("#tab-content",form1).children('#tab1').addClass('active');
            result = $("#cm_code").val();
            $("#add_cm_code").val(result);
            $("#edit_cm_code").val(result);
            $("input[type='checkbox']",form1).removeAttr('checked');
            $("input[type='checkbox']",form1).closest('span').removeAttr('class');

            success1.hide();
            error1.hide();
            form1.trigger('reset');
            form1.find('div.control-group').removeClass('success');
            $("#step1_setoran_lwk",form1).val($("#default_setoran_lwk").val());
            $("#step1_setoran_mingguan",form1).val($("#default_minggon").val());
            $(".button-first",form1).trigger('click');
            $(".button-previous",form1).hide();
      ...
      form1.validate({
          ...
          rules: {
              ...
              step2_pribadi_usia: {
                  // required: true,
                  // number: true,
                  add_pribadi_validate_usia: true
              },
              step2_pribadi_no_ktp: {
                  required: true,
                  number: true
              },
              step2_pasangan_usia:{
                  add_pasangan_validate_usia: true
              }
          },
      ...
      $("a#link-edit").live('click',function(){
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            $("#step2_pribadi_no_ktp",form2).val(response.no_ktp);
			$("#step2_pribadi_no_hp",form2).val(response.no_hp);
            ...
            else if ( response.desa != response.koresponden_desa || response.desa == "" ){
               sama = false;
            }
            else if ( response.kecamatan != response.koresponden_kecamatan || response.kecamatan == "" ){
               sama = false;
            }
            else if ( response.kabupaten != response.koresponden_kabupaten || response.kabupaten == "" ){
               sama = false;
            }
            else if ( response.kodepos != response.kodepos || response.kodepos == "" ){
               sama = false;
            }

            if ( sama == true ){
               $("#sama",form2).attr('checked',true);
               $("#sama",form2).closest('span').attr('class','checked');
            }else{
               $("#sama",form2).attr('checked',false);
               $("#sama",form2).closest('span').removeClass('checked');
            }
            ...
            $("#step2_pasangan_no_ktp",form2).val(response.p_no_ktp);
			$("#step2_pasangan_no_hp",form2).val(response.p_no_hp);
			...
			$("#step3_rekening_listrik",form2).val(response.rekening_listrik);
			$("#step3_rekening_listrik_biaya",form2).val(response.rekening_listrik_biaya);
			$("#step3_rekening_pdam",form2).val(response.rekening_pdam);
			$("#step3_rekening_pdam_biaya",form2).val(response.rekening_pdam_biaya);
			$("#step3_bpjs",form2).val(response.bpjs);
			$("#step3_bpjs_biaya",form2).val(response.bpjs_biaya);
      ...
      form2.validate({
          ...
          rules: {
              ...
              step2_pribadi_usia: {
                  // required: true,
                  // number: true,
                  edit_pribadi_validate_usia: true
              },
              step2_pribadi_no_ktp: {
                  required: true,
                  number: true
              ...
              step2_pasangan_usia: {
                  edit_pasangan_validate_usia: true
              }
          },
        ...
        if(form2.valid()==true)
        {
          $.ajax({
           ...
           success: function(response){
             if(response.success==true){
               alert(response.message);
               $("input[type='checkbox']",form2).removeAttr('checked');
               $("input[type='checkbox']",form2).closest('span').removeAttr('class');
               success2.hide();
               error2.hide();
               form2.trigger('reset');
               form2.find('div.control-group').removeClass('success');
