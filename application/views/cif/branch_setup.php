      ...
      <div class="clearfix">
         ...
         <div class="btn-group">
            <button id="btn_delete" class="btn red">
              Delete News <i class="icon-remove"></i>
            </button>
         </div>
      ...
      <table class="table table-striped table-bordered table-hover" id="kantor_cabang">
         <thead>
            <tr>
               ...
               <th width="25%" class="hidden-480">Jenis Cabang</th>
               <th>Edit</th>
            </tr>
         </thead>
         <tbody>
...
<div id="add" class="hide">
   ...
   <div class="portlet box green">
      <div class="portlet-title">
         <div class="caption"><i class="icon-reorder"></i>Tambah Kantor Cabang</div>
         <div class="tools">
            <a href="javascript:;" class="collapse"></a>
         </div>
      </div>
      <div class="portlet-body form">
         ...
         <form action="<?php echo site_url('administration/add_news'); ?>" method="post" enctype="multipart/form-data" id="form_add" class="form-horizontal">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <select name="cabang_induk" class="medium m-wrap" data-required="1">
                     <option value="">PILIH</option>
                  </select>
               </div>
            </div>            
            <div class="control-group">
               ...
               <div class="controls">
                  <input type="text" name="id_kantor" data-required="1" class="medium m-wrap"/>
               </div>
            </div>
...
<div class="portlet box blue" id="wrapper-table-petugas">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Petugas Lapangan</div>
      <div class="tools">
         <a href="javascript:;" class="collapse"></a>
      </div>
   </div>
   <div class="portlet-body">
      <div class="clearfix">
         <div class="btn-group">
            ...
            Add Petugas <i class="icon-plus"></i>
            </button>
         </div>
         <div class="btn-group">
            <button id="btn_delete" class="btn red">
      ...
      <table class="table table-striped table-bordered table-hover" id="news_table">
         <thead>
            <tr>
               ...
               <th width="25%" class="hidden-480">Kantor</th>
               <th>Edit</th>
            </tr>
         </thead>
         <tbody>
...
<div id="add_petugas" class="hide">
   ...
   <div class="portlet box green">
      <div class="portlet-title">
         <div class="caption"><i class="icon-reorder"></i>Tambah Petugas Lapangan</div>
         <div class="tools">
            <a href="javascript:;" class="collapse"></a>
         </div>
      </div>
