...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Rekap Saldo Tabungan Bulan Lalu </div>
      <div class="tools">
            ...
            <!-- BEGIN FILTER-->
              <table id="sorting_saldo">
                ...
                <tr>
                  <td></td>
                  <td>
                     <button class="green btn" id="previewpdf">View PDF</button>
                     <button class="green btn" id="previewxls">View Excel</button>
                  </td>
                  <td></td>
                  <td></td>
                  <td></td>
  ...
  $("#result option:selected").live('dblclick',function(){
    $("#select_cabang").trigger('click');
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_saldo_tabungan_lalu/'+cabang+'/'+hari+'/'+bulan+'/'+tahun);
      });
      ...
      $("#previewxls").click(function(e)
      {
        ...
        var bulan = tanggal.substr(5,2);
        var tahun = tanggal.substr(0,4);
        window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_saldo_tabungan_lalu/'+cabang+'/'+hari+'/'+bulan+'/'+tahun);
      });
