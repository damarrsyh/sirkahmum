  ...
  <table id="hor-minimalist-b" style="margin:0;" align="center">
    <thead>
      <tr>
        ...
        <th style="padding:5px; text-align: center; border-bottom:solid 1px #555; border-top: solid 1px #555; border-right: solid 1px #555; font-size:11px; font-weight: bold; width:90px;">Jumlah</th>
        <th style="padding:5px; text-align: center; border-bottom:solid 1px #555; border-top: solid 1px #555; border-right: solid 1px #555; font-size:11px; font-weight: bold; width:90px;">Freq</th>
    ...
    <tbody>
      <tr class="value">
        ...
        <td style="padding:5px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:left;">-</td>
        <td style="padding:5px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:left;">-</td>
      ...
      <?php 
        ...
        $saldo +=($key['tab_kelompok_cr']*$key['freq']);
      ?>
      <tr class="value">
        ...
        <td style="padding:5px; font-size:11px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:center;"><?php echo $key['created_date'];?></td>
        <td style="padding:5px; font-size:11px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:center;">Credit</td>
        <td style="padding:5px; font-size:11px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:left;" align="right"><?php echo number_format($key['tab_kelompok_cr'],0,',','.');?></td>
        <td style="padding:5px; font-size:11px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:left;" align="center"><?php echo $key['freq'];?></td>
        <td style="padding:5px; font-size:11px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:right;"><?php echo number_format($saldo,0,',','.');?></td>
      </tr>
      <?php 
          endforeach;
      ?>
