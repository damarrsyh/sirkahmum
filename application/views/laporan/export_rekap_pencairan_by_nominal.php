...
<div style="width:100%;">
  ...
  <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:16px;">
  Rekap Pengajuan Pembiayaan Berdasarkan Nominal
  </div>
...
<table id="hor-minimalist-b" align="center">
    <tbody>
      <tr>
            ...
            <td class="pokok" style="width:80px;">Pencairan</td>
      ...
      <tr class="value">
            ...
            <td class="val_anggota" style="padding:2px;"><?php echo $data['nominal_text'];?></td>
