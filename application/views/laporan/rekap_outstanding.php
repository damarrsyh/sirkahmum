   ...
   /* END DIALOG ACTION REMBUG */
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if(branch_code==""){
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_outstanding_deposito/'+produk+'/'+branch_code);
        }
      });
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        if(branch_code==""){
          ...
          window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_outstanding_deposito/'+produk+'/'+branch_code);
        }
      });
