...
/* BEGIN DIALOG ACTION BRANCH */
   ...
   /* END DIALOG ACTION REMBUG */
      ...
      $("#previewxls").click(function(e)
      {
        ...
        window.open('<?php echo site_url();?>laporan_to_excel/export_lap_transaksi_tabungan/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code);
      });
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        var tanggal = datepicker_replace($("#tanggal").val());
        var tanggal2 = datepicker_replace($("#tanggal2").val());
        window.open('<?php echo site_url();?>laporan_to_pdf/export_lap_transaksi_tabungan/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code);
      });
