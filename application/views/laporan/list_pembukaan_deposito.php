...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Pembukaan Deposito</div>
      <div class="tools">
    ...
    $("#select_cabang").trigger('click');
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        if (tanggal=="" && tanggal2=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_pdf/export_list_pembukaan_deposito/'+tanggal+'/'+tanggal2+'/'+cabang+'/'+produk);
        }
      });
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if (tanggal=="" && tanggal2=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_list_pembukaan_deposito/'+tanggal+'/'+tanggal2+'/'+cabang+'/'+produk);
        }
      });
