...
<table id="hor-minimalist-b" align="center">
  <thead>
      ...
      <td class="title" rowspan="2">Cabang</td>
  ...
  $total_saldo_catab = 0;
    ...
    $status_pyd_kreditur = $data['status_pyd_kreditur'];
    ...
    <tr>
      ...
      <td class="konten"><?php echo $status_pyd_kreditur; ?></td>
      ...
      <td class="konten"><?php echo $batch; ?></td>
    </tr>
    <?php } ?>    
    <tr>
      <td class="title" colspan="14">Total</td>
