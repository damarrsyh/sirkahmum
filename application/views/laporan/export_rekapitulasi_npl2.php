...
<page>
      <div style="width:100%;">
        ...
        <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:18px;">
        Laporan Rekap PAR <?php echo $tanggal_hitung;?>
        </div>
        <hr>
      </div>
<table id="hor-minimalist-b" >
    <tbody>
      <tr>
            ...
            <td class="ket_bold" rowspan="2" style="width:90px;">Petugas</td>
      ...
      <tr class="value">
        ...
        <td class="val_anggota" style="font-size:9px;white-space:nowrap;"><?php echo $data['fa_name'];?></td>

        <td class="val_anggota" align="center" style="font-size:9px;"><?php if($data['jml0']==""){ echo "0";} else { echo $data['jml0'];}?></td>
        <td class="val_anggota" align="right" style="font-size:9px;"><?php if($data['saldo_pokok0']==""){ echo "0";} else { echo number_format($data['saldo_pokok0'],0,',','.');}?></td>
        <td class="val_anggota" align="right" style="font-size:9px;"><?php if($data['cpp0']==""){ echo "0";} else { echo number_format($data['cpp0'],0,',','.');}?></td>
