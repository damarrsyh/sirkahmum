...
<table align="center" cellpadding="0" cellspacing="0">    
  ...
  <tr>
      ...
      <th rowspan="2" style="background-color:#eee;padding:5px;text-align:center;border:1px solid #ddd;border-bottom:2px solid #ddd;padding-top:20px;" width="80">Saldo Margin</th>
      <th rowspan="2" style="background-color:#eee;padding:5px;text-align:center;border:1px solid #ddd;border-bottom:2px solid #ddd;padding-top:20px;" width="80">Saldo Catab</th>
