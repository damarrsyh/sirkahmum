...
<div class="row-fluid">
   <div class="span12">
      ...
      <h3 class="form-section">
        Laporan <small>Rekapitulasi PAR</small>
      </h3>
      <!-- END PAGE TITLE-->
   </div>
</div>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Laporan Rekapitulasi PAR</div>
      <div class="tools">
  ...
  $("#rekap_by").change(function(){
   ...
   $("#preview_pdf").click(function(e){
      ...
      switch(rekap_by){
        ...
        window.open('<?php echo site_url();?>laporan_to_pdf/export_rekapitulasi_npl_petugas/'+branch_code+'/'+tanggal_hitung+'/REKAP KOLEKTIBILITAS BY PETUGAS');
        ...
        break;
        case "kol":
        window.open('<?php echo site_url();?>laporan_to_pdf/export_rekapitulasi_kol/'+branch_code+'/'+kol+'/'+tanggal_hitung+'/REKAP KOLEKTIBILITAS BY PAR');
        break;
      }
   });
   ...
   $("#preview_xls").click(function(e){
      ...
      switch(rekap_by){
        ...
        if(tanggal_hitung==""){
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_rekapitulasi_npl_petugas/'+branch_code+'/'+tanggal_hitung);
        }
        break;
        case "rembug":
        if(tanggal_hitung==""){
