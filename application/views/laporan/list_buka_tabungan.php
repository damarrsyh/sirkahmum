...
var showin = function(){
  ...
  jQuery("#list485").jqGrid({
    url: site_url+'laporan/jqgrid_list_buka_tabungan',
    //data: mydata,
    datatype: 'json',
    height: 'auto',
    autowidth: true,
    ...
    colNames:['No Rekening','Nama','Majelis','Produk','Tgl Buka','Jangka Waktu','Tgl Jto','Setoran','Status','Saldo'],
    colModel:[
...
// end search rembug
  ...
  $("#previewcsv").click(function(e)
  {
    ...
    if (produk=="") {
      ...
      window.open('<?php echo site_url();?>laporan_to_csv/export_list_buka_tabungan/'+produk+'/'+tanggal+'/'+tanggal2+'/'+cabang);
    }
  });
