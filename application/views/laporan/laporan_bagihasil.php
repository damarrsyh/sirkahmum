...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Laporan Bagihasil</div>
      <div class="tools">
         ...
         <form>
            ...
            <table id="filter-form">
               ...
               <tr>
                  ...
                  <td valign="top">
                    <input type="text" name="tanggal" id="tanggal" tabindex="2" placeholder="dd/mm/yyyy" class="mask_date date-picker" value="<?php echo date('d/m/Y'); ?>" maxlength="10" style="width:100px;padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;">
                    sd
                    <input type="text" name="tanggal2" id="tanggal2" tabindex="2" placeholder="dd/mm/yyyy" class="mask_date date-picker" value="<?php echo date('d/m/Y'); ?>" maxlength="10" style="width:100px;padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;">
                  </td>
               </tr>
               <tr>
                  <td></td>
...
/* BEGIN DIALOG ACTION BRANCH */
   ...
   /* END DIALOG ACTION REMBUG */
      ...
      $("#previewxls").click(function(e)
      {
        ...
        window.open('<?php echo site_url();?>laporan_to_excel/export_laporan_bagihasil/'+tanggal+'/'+tanggal2+'/'+branch_code);
      });
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        var tanggal = datepicker_replace($("#tanggal").val());
        var tanggal2 = datepicker_replace($("#tanggal2").val());
        window.open('<?php echo site_url();?>laporan_to_pdf/export_laporan_bagihasil/'+tanggal+'/'+tanggal2+'/'+branch_code);
      });
