...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Rekap Angsuran</div>
      <div class="tools">
				...
				<tr id="r_cabang">
                 ...
                 <tr>
                    ...
                    <td>
                      ...
                      <select name="filter" id="filter" style="width:220px;">
                        ...
                        <option value="6">Sumber Dana</option>
                      </select>
                    </td>
                 </tr>
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        var filter = $("#filter").val();
          ...
          {            
              ...
              {            
                window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_semua_cabang/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
              }        
              else
              {            
                window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_cabang/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
              } 
          } 
          else if (filter=='1') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_rembug/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }
          else if (filter=='2') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_petugas/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }
          else if (filter=='3') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_produk/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }
          else if (filter=='4') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_peruntukan/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }
          else if (filter=='5') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_sektor_usaha/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }
          else if(filter == '6')
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_kreditur/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }else
          {
      ...
      $("#previewxls").click(function(e)
      {
        ...
        var filter = $("#filter").val();
          ...
          {            
              if(cabang=='0000' || cabang=='') 
              {            
                window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_semua_cabang/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
              }        
              else
              {            
                window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_cabang/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
              } 
          } 
          else if (filter=='1') 
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_rembug/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }
          else if (filter=='2') 
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_petugas/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }
          else if (filter=='3') 
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_produk/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }
          else if (filter=='4') 
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_peruntukan/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }
          else if (filter=='5') 
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_sektor_usaha/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }
          else if(filter == '6')
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_kreditur/'+cabang+'/'+tanggal+'/'+tanggal2+'/'+financing_type);
          }else
          {
            alert("Parameter Kosong");
          }
