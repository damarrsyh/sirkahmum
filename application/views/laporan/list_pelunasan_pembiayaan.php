...
var showin = function(){
  ...
  jQuery("#list485").jqGrid({
    url: site_url+'laporan/jqgrid_list_pelunasan_pembiayaan',
    //data: mydata,
    datatype: 'json',
    height: 'auto',
    autowidth: true,
    ...
    colNames:['Tgl. Lunas','No. Rekening','Nama','Majelis','Sumber Dana','Pembiayaan','Pokok','Margin','Jangka Waktu','Jatuh Tempo','Cnt','Pokok','Margin'],
    colModel:[
      {name:'tanggal_lunas',index:'tanggal_lunas'},
      ...
      //{name:'periode_jangka_waktu',index:'periode_jangka_waktu',align:'right'},
    ],
    shrinkToFit: true,
    pager: "#plist485",
    viewrecords: true,
...
//  END
  ...
  $('#financing_type').change(function(){
      ...
      var kreditur = $('#kreditur').val();
		  ...
		  var site = '<?php echo site_url('laporan_to_pdf/list_pelunasan_pembiayaan'); ?>';
		  var conf = true;
      ...
      if(kreditur == ''){
        ...
        var conf = false;
		  ...
		  if(conf == true){
			  window.open(site+'/'+branch_code+'/'+financing_type+'/'+fa_code+'/'+cm_code+'/'+tanggal+'/'+tanggal2+'/'+kreditur);
		  }
      });
      ...
      var kreditur = $('#kreditur').val();
		  ...
		  var tanggal2 = $('#tanggal2').val();
		  var tanggal2 = datepicker_replace(tanggal2);
		  var site = '<?php echo site_url('laporan_to_excel/list_pelunasan_pembiayaan'); ?>';
		  var conf = true;
      ...
      var kreditur = $('#kreditur').val();
		  ...
		  var tanggal2 = $('#tanggal2').val();
		  var tanggal2 = datepicker_replace(tanggal2);
		  var site = '<?php echo site_url('laporan_to_csv/list_pelunasan_pembiayaan'); ?>';
		  var conf = true;
