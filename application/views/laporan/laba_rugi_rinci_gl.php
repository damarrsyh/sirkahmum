...
/* BEGIN SCRIPT */
   ...
   $("#preview").click(function(e){
        ...
        window.open('<?php echo site_url();?>laporan_to_pdf/export_lap_lr_rinci/'+branch_code+'/'+periode_bulan+'/'+periode_tahun+'/'+periode_hari);
   });
   ...
   $("#previewxls").click(function(e){
        ...
        var periode_bulan = $("#periode").val().substr(2,2);
        var periode_tahun = $("#periode").val().substr(4,4);
        window.open('<?php echo site_url();?>laporan_to_excel/export_lap_lr_rinci/'+branch_code+'/'+periode_bulan+'/'+periode_tahun+'/'+periode_hari);
   });
