...
<table id="hor-minimalist-b" align="center">
  ...
  <tbody>
    ...
    foreach($result as $datax){
      $sum_anggota += $datax['jumlah'];
      $sum_pokok += $datax['saldo_pokok'];
    }
    ...
    <tr>
      ...
      <td class="konten" style="text-align:left"><?php echo $data['cm_name'];?></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td class="zero">&nbsp;</td>
      <td class="konten"><?php echo number_format($total_anggota,0,',','.');?></td>
