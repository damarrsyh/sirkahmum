...
<table id="hor-minimalist-b" align="center">
    <tbody>
      <tr>
            ...
            <td class="anggota" style="width:100px;">Rembug</td>
            <td class="jumlah" style="width:80px;">Jumlah</td>
            <td class="pokok" style="width:80px;">Pokok</td>
            <td class="pokok" style="width:80px;">Persentase Jumlah</td>
            <td class="pokok" style="width:80px;">Persentase Pokok</td>
      </tr>
      <?php
        $sum_anggota = 0;
        $sum_pokok = 0;
        foreach ($result as $data):     
        $sum_anggota+=$data['jumlah_anggota'];     
      ...
      $total_pokok = 0;
        ...
        $persen_jumlah = $data['jumlah_anggota']/$sum_anggota*100;
        $persen_nominal = $data['pokok']/$sum_pokok*100; 
      ?>
      <tr class="value">
            <td class="val_anggota"><?php echo $no++;?></td>
            <td style="width:300px;"  class="val_anggota"><?php echo $data['display_text'];?></td>
