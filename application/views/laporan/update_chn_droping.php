...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Update Chanelling Droping</div>
      <div class="tools">
...
<script type="text/javascript">
  ...
  $("#export_excel").on('submit',(function(e) {
    e.preventDefault();
    $.ajax({
          url: site_url+"laporan/imp_chn_droping_update_excel",
      type: "POST",
...
var showin = function(){
  ...
  $("#update").click(function(){
     ...
     $.ajax({
       type: "POST",
       url: site_url+"laporan/chn_droping_update",
       dataType: "json",
