...
<table id="hor-minimalist-b" >
    <tbody>
      <tr>
            ...
            <td class="ket_bold" rowspan="2" style="width:70px;">Peruntukan</td>
      ...
      <?php 
        ...
        $total_jumlah6 += $total;
        $total_saldo0 += $data['saldo_pokok0'];
      ...
      <tr class="value">
        ...
        <td class="val_anggota" style="font-size:9px;white-space:nowrap;"><?php echo $data['display_text'];?></td>
