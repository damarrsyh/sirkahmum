...
<div class="portlet box blue">
  <div class="portlet-title">
     <div class="caption"><i class="icon-reorder"></i>LIST KEHADIRAN ANGGOTA</div>
     <div class="tools">
     </div>
  </div>
...
$("#export_excel").click(function(e){
  ...
  window.open(site_url+"laporan_to_excel/export_list_anggota_absen/"+branch_code+"/"+cm_code+"/"+tanggal+"/"+tanggal2);
});
...
$("#export_csv").click(function(e){
  ...
  tanggal = $("#tanggal").val().replace(/\//g,'');
  tanggal2 = $("#tanggal2").val().replace(/\//g,'');
  window.open(site_url+"laporan_to_csv/export_list_anggota_absen/"+branch_code+"/"+cm_code+"/"+tanggal+"/"+tanggal2);
});
...
$("#export_pdf").click(function(e){
  ...
  tanggal = $("#tanggal").val().replace(/\//g,'');
  tanggal2 = $("#tanggal2").val().replace(/\//g,'');
  window.open(site_url+"laporan_to_pdf/export_list_anggota_absen/"+branch_code+"/"+cm_code+"/"+tanggal+"/"+tanggal2);
});
