    ...
    <table id="hor-minimalist-b" style="margin:0;" align="center">
        ...
        <tbody>
            ...
            <?php 
              ...
              $saldo +=($key['tab_wajib_cr']*$key['freq']);
            ?>
            <tr class="value">
              ...
              <td style="padding:5px; font-size:11px;border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:left;" align="right"><?php echo number_format($key['tab_wajib_cr'],0,',','.');?></td>
