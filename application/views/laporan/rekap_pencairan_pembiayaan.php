  ...
  filter = $(this).val();
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        var filter = $("#filter").val();
          ...
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_pencairan_pembiayaan_rembug/'+tanggal+'/'+tanggal2+'/'+cabang);
          }
          else if (filter=='2') 
          {
          ...
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_pencairan_pembiayaan_nominal/'+tanggal+'/'+tanggal2+'/'+cabang);
          }
		  else if (filter=='6') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_pencairan_pembiayaan_sektor/'+tanggal+'/'+tanggal2+'/'+cabang);
          }
          else if(filter == '7')
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_pencairan_pembiayaan_kreditur/'+tanggal+'/'+tanggal2+'/'+cabang);            
          }else 
          {           
      ...
      $("#previewxls").click(function(e)
      {
        ...
        var filter = $("#filter").val();
          ...
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_pencairan_pembiayaan_rembug/'+tanggal+'/'+tanggal2+'/'+cabang);
          }
          else if (filter=='2') 
          {
          ...
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_pencairan_pembiayaan_nominal/'+tanggal+'/'+tanggal2+'/'+cabang);
          }
		  else if (filter=='6') 
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_pencairan_pembiayaan_sektor/'+tanggal+'/'+tanggal2+'/'+cabang);
          }
          else if(filter =='7')
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_pencairan_pembiayaan_kreditur/'+tanggal+'/'+tanggal2+'/'+cabang);
          }else 
          {
            alert("Parameter Kosong");            
          }
