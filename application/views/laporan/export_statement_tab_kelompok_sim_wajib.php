      ...
      <tbody>
          ...
          ?>
              <tr class="value">
                ...
                <td style="padding:5px; font-size:11px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:left;" align="right"><?php echo number_format($key['setoran_mingguan'],0,',','.');?></td>
                <td style="padding:5px; font-size:11px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:left;" align="center">0</td>
