...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Tabungan Bulan Lalu</div>
      <div class="tools">
...
var gridaja = function(){
	...
	jQuery('#list485').jqGrid({
		url: site_url+'laporan/jqgrid_list_outstanding_tabungan_lalu',
		datatype: 'json',
		height: 'auto',
		autowidth: true,
		postData: {
	  	...
	  	colModel:[
			{name:'account_saving_no',index:'account_saving_no'},
		  	...
		  	{name:'saldo_riil',index:'saldo_riil',align:"right",formatter:"currency",formatoptions:{decimalSeparator:",",thousandsSeparator:".",decimalPlaces:0}}
	  	],
	  	shrinkToFit: true,
	  	pager: '#plist485',
	  	viewrecords: true,
  ...
  $('#previewpdf').click(function(){
	  ...
	  var site = '<?php echo site_url('laporan_to_pdf/export_lap_list_outstanding_tabungan_lalu'); ?>';
	  ...
	  if(conf == true){
		  window.open(site+'/'+branch_code+'/'+jenis_tabungan+'/'+fa_code+'/'+cm_code+'/'+product+'/'+hari+'/'+bulan+'/'+tahun);
	  }
  });
  ...
  $('#previewxls').click(function(){
	  ...
	  var product = $('#product').val();
	  var fa_code = $('#fa_code').val();
	  var site = '<?php echo site_url('laporan_to_excel/export_lap_list_outstanding_tabungan_lalu'); ?>';
	  var tanggal = $('#tanggal').val();
  ...
  $('#previewcsv').click(function(){
	  ...
	  var product = $('#product').val();
	  var fa_code = $('#fa_code').val();
	  var site = '<?php echo site_url('laporan_to_csv/export_lap_list_outstanding_tabungan_lalu'); ?>';
	  var tanggal = $('#tanggal').val();
