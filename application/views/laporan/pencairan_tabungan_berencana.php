...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Pencairan Tabungan Berencana</div>
      <div class="tools">
   ...
   /* END DIALOG ACTION REMBUG */
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if (produk=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_lap_pencairan_tabungan_berencana/'+produk+'/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code);
        }
      });
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        if (produk=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_pdf/export_lap_pencairan_tabungan_berencana/'+produk+'/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code);
        }
      });
      ...
      $("#previewcsv").click(function(e)
      {
        ...
        if (produk=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_csv/export_lap_pencairan_tabungan_berencana/'+produk+'/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code);
        }
      });
