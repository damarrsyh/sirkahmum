...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Rekap Anggota Keluar</div>
      <div class="tools">
        ...
        <tr>
                    ...
                    <td>
                      ...
                      <select name="filter" id="filter" style="width:200px;">
                        ...
                        <option value="3">Alasan Keluar</option>
                      </select>
                    </td>
                 </tr>
    ...
    $('#kecamatan').hide().val('');
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        var filter = $("#filter").val();
          ...
          {            
              ...
              {            
                window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_anggota_keluar_semua_cabang/'+tanggal+'/'+tanggal2+'/'+cabang);
              }        
              else
              {            
                window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_anggota_keluar_semua_cabang/'+tanggal+'/'+tanggal2+'/'+cabang);
          ...
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_anggota_keluar_kecamatan/'+tanggal+'/'+tanggal2+'/'+cabang+'/'+kecamatan);
          }
		  else if (filter=='2') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_anggota_keluar_petugas/'+tanggal+'/'+tanggal2+'/'+cabang);
          }        
          else if (filter=='3') 
          {
      ...
      $("#previewxls").click(function(e)
      {
        ...
        var filter = $("#filter").val();
          ...
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_anggota_keluar_petugas/'+tanggal+'/'+tanggal2+'/'+cabang);
          }
          else if (filter=='3') 
          {
