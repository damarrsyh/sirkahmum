...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Rekap Cashflow Transaksi Rembug</div>
      <div class="tools">
            ...
            <!-- BEGIN FILTER-->
              <table id="sorting_saldo">
				...
				<tr id="r_cabang">
                 ...
                 <tr>
                    <td style="padding-bottom:10px;" width="100">Filter By</td>
                    <td><input type="text" name="awal_trx_date" id="awal_trx_date" value="<?php echo $trx_date; ?>" data-required="1" placeholder="dd/mm/yyyy" class="mask-date date-picker small m-wrap"/> s.d <input type="text" name="akhir_trx_date" id="akhir_trx_date" value="<?php echo $trx_date; ?>" data-required="1" placeholder="dd/mm/yyyy" class="mask-date date-picker small m-wrap"/></td>
                 </tr>
                
                <tr>
                  <td></td>
                  <td>
                     <button class="green btn hidden" id="previewpdf">Preview</button>
...
<script type="text/javascript">
      ...
      $("#previewxls").click(function(e){
        ...
        var cabang = $("#cabang").val();
        var filter = $("#filter").val();
		var awal = datepicker_replace($('#awal_trx_date').val());
		var akhir = datepicker_replace($('#akhir_trx_date').val());

		if(filter == '1'){
			window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_cashflow_transaksi_rembug/'+cabang+'/'+awal+'/'+akhir);
		} else if(filter == '2'){
			window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_cashflow_transaksi_petugas/'+cabang+'/'+awal+'/'+akhir);
		} else {
			alert("Parameter Kosong");
		}
