...
<table id="hor-minimalist-b" align="center">
    <tbody>
        <tr>
          ...
          <td rowspan="2" class="title">Majlis Lama </td>
          <td rowspan="2" class="title">Majlis Baru </td> 		      
		      <td colspan="3" class="title">Saldo Pembiayan </td>
          <td colspan="7" class="title">Saldo Simpanan </td>
          <td rowspan="2" class="title">Alasan Mutasi </td>
          <td rowspan="2" class="title">Keterangan Mutasi </td>
        </tr>
        <tr>
        ...
        <?php 
          ...
          foreach ($list_anggota_mutasi as $data):
      ...
      <tr class="value">
        ...
        <td class="konten"><?php echo $data['majlis_lama'];?></td>   
        <td class="konten"><?php echo $data['majlis_baru'];?></td>          
