                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td scope="col">
                                <center> <?php echo number_format($graph['b1'],0,',','.');?> </center>
                            </td>
                            <td scope="col">
                                <center> <?php echo number_format($graph['b2'],0,',','.');?> </center>
                            </td>
                            <td scope="col">
                                <center> <?php echo number_format($graph['b3'],0,',','.');?> </center>
                            </td>
                            <td scope="col">
                                <center> <?php echo number_format($graph['b4'],0,',','.');?> </center>
                            </td>
                            <td scope="col">
                                <center> <?php echo number_format($graph['b5'],0,',','.');?> </center>
                            </td>
                            <td scope="col">
                                <center> <?php echo number_format($graph['b6'],0,',','.');?> </center>
                            </td>
                            <td scope="col">
                                <center> <?php echo number_format($graph['b7'],0,',','.');?> </center>
                            </td>
                            <td scope="col">
                                <center> <?php echo number_format($graph['b8'],0,',','.');?> </center>
                            </td>
                            <td scope="col">
                                <center> <?php echo number_format($graph['b9'],0,',','.');?> </center>
                            </td>
                            <td scope="col">
                                <center> <?php echo number_format($graph['b10'],0,',','.');?> </center>
                            </td>
                            <td scope="col">
                                <center> <?php echo number_format($graph['b11'],0,',','.');?> </center>
                            </td>
                            <td scope="col">
                                <center> <?php echo number_format($graph['b12'],0,',','.');?> </center>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
