...
<table id="hor-minimalist-b" align="center">
    <tbody>
      <tr>
			...
			<td class="pokok" style="width:70px;">Kode </td>
            <td class="pokok" style="width:160px;">Keterangan </td>
      ...
      <tr class="value">
			...
			<td class="val_no" align="center"><?php echo $data['kode'];?></td>
            <td class="val_anggota" align="center"><?php echo $data['keterangan'];?></td>
            <td class="val_anggota" align="center"><?php echo number_format($data['jumlah'],0,',','.');?></td>
      </tr>
    <?php 
        endforeach;
    ?>      
      <tr class="value">
            <td class="val_anggota" align="center"><?php echo " " ;?></td>
			<td class="val_anggota" align="center"><?php echo " " ;?></td>
			<td class="val_anggota" align="center"><?php echo "Total " ;?></td>
