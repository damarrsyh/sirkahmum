...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Proyeksi Angsuran</div>
      <div class="tools">
...
// END
  ...
  $('#previewpdf').click(function(){
    ...
    var kreditur = $('#kreditur').val();
	  ...
	  var site = '<?php echo site_url('laporan_to_pdf/export_list_proyeksi_angsuran'); ?>';
	  var conf = true;
  ...
  $('#previewxls').click(function(){
    ...
    var kreditur = $('#kreditur').val();
	  ...
	  var tanggal2 = datepicker_replace(tanggal2);
	  var fa_code = $('#account_cash_code').val();
	  var site = '<?php echo site_url('laporan_to_excel/export_list_proyeksi_angsuran'); ?>';
      ///var site_individu = '<?php ///echo site_url('laporan_to_excel/export_list_proyeksi_angsuran_individu'); ?>';
	  var conf = true;
  ...
  $('#previewcsv').click(function(){
    ...
    var kreditur = $('#kreditur').val();
	  ...
	  var tanggal2 = datepicker_replace(tanggal2);
	  var fa_code = $('#account_cash_code').val();
	  var site = '<?php echo site_url('laporan_to_csv/export_list_proyeksi_angsuran'); ?>';
