...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Rekap Pembukaan Deposito</div>
      <div class="tools">
    ...
    $("#select_cabang").trigger('click');
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        if (produk=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_pembukaan_deposito/'+cabang+'/'+produk+'/'+tanggal+'/'+tanggal2);
        }
      });
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if (produk=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_pembukaan_deposito/'+cabang+'/'+produk+'/'+tanggal+'/'+tanggal2);
        }
      });
