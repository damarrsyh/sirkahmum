...
<div class="row-fluid">
   <div class="span12">
      ...
      <h3 class="form-section">
        Laporan <small>History Kehadiran Anggota</small>
      </h3>
      <!-- END PAGE TITLE-->
   </div>
</div>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>History kehadiran Anggota</div>
      <div class="tools">
   ...
   <div class="portlet-body form">
      <form action="#" class="form-horizontal" id="form-filter">
        ...
        <div class="form-actions">
          ...
          <button id="preview_xls" class="btn green" type="button">XLS</button>
        </div>
      </form>
   </div>
</div>
...
$("#result option","#dialog_kantor_cabang").live('dblclick',function(){
  ...
  $("#preview_pdf").click(function(){
    ...
    if(bValid==false){
      ...
      window.open(site_url+'laporan_to_pdf/statement_kehadiran/'+branch_code+'/'+cm_code+'/'+cif_no+'/'+tanggal+'/'+tanggal2,'_blank');
    }

  })
});

$("#preview_xls").click(function(){
    ...
    if(bValid==false){
      ...
      window.open(site_url+'laporan_to_excel/statement_kehadiran/'+branch_code+'/'+cm_code+'/'+cif_no+'/'+tanggal+'/'+tanggal2,'_blank');
    }
