...
<page>
      <div style="width:100%;">
        ...
        <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:18px;">
        <?php echo $tanggal1_;?> s/d <?php echo $tanggal2_;?>
        </div>
        <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:18px;">
        Rekap Angsuran <?php echo $post_pembiayaan;?> Berdasarkan Semua Cabang
        </div>
        <hr>
      </div>
<table id="hor-minimalist-b" align="center">
    <tbody>
      <tr>
            ...
            <td class="pokok" style="width:50px;">Persentase Jumlah</td>
            <td class="pokok" style="width:50px;">Persentase Pokok</td>
      </tr>
      <?php
        $sum_anggota = 0;
        $sum_pokok = 0;
