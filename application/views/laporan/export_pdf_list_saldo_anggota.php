...
<page>
      <div style="width:100%;">
        ...
        <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:18px;">
        Laporan Saldo Rekening Anggota
        </div>
        <hr>
      </div>
<table id="hor-minimalist-b" align="center">
    <tbody>
        <tr>
          ...
          <td colspan="4" align="center" valign="middle" class="anggota2" >Saldo Pembiayaan</td>
          <td rowspan="2" align="center" valign="middle" class="anggota2" style="width:70px;" >Petugas</td>
        </tr>
        <tr>
          <td align="center" valign="middle" class="no_bold" style="width:35px;">ID</td>
          ...
          <td align="center" valign="middle" class="no_bold" style="width:26px;">Kelompok</td>
          <td align="center" valign="middle" class="no_bold" style="width:24px;">Sukarela</td>
          <td align="center" valign="middle" class="no_bold" style="width:26px;">Tab. Berencana</td>
          <td align="center" valign="middle" class="no_bold" style="width:26px;">Pemby. Pokok</td>
          <td align="center" valign="middle" class="no_bold" style="width:26px;">Pemby. Margin</td>
          <td align="center" valign="middle" class="no_bold" style="width:26px;">Saldo Pokok</td>
     ...
     <?php 
        ...
        foreach ($saldo_tabungan as $data):
          ...
          $total_tabungan_berencana += $data['saldo_taber'];
          $total_pokok += $data['pokok'];
          $total_margin += $data['margin'];
      ...
      <tr class="value">
        ...
        <td align="right" valign="middle" style=" padding: 3px 2px; border-bottom:solid 1px #999; border-right:solid 1px #999;"><?php echo number_format($data['saldo_taber'],0,',','.');?></td>
     ...
     <?php 
      ...
      <tr class="value">
        ...
        <td align="right" valign="middle" style=" padding: 3px 2px; border-bottom:solid 1px #999; border-right:solid 1px #999; font-weight: bold;"><?php echo number_format($total_tabungan_berencana,0,',','.');?></td>
