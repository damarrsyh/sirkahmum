      ...
      <div class="clearfix">
            <!-- BEGIN FILTER-->
              ...
              <?php } ?></td>
                   ...
                   <tr>
                      <td>Tanggal</td>
                      <td><input type="text" name="tanggal" id="tanggal" tabindex="2" placeholder="dd/mm/yyyy" class="mask_date date-picker" value="<?php echo $current_date; ?>" maxlength="10" style="width:100px;padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;">
                        sd
...
var showin = function(){
  ...
  jQuery("#list485").jqGrid({
    url: site_url+'laporan/jqgrid_list_jatuh_tempo',
    //data: mydata,
    datatype: 'json',
    height: 'auto',
    autowidth: true,
    ...
    colNames:['Tgl. Droping','No. Rekening','Nama','Majelis','Jenis','Desa','Ke','Pokok','Margin','Sisa','Jangka Waktu','Tgl Jatuh Tempo'],
    colModel:[
      ...
      {name:'sisa',index:'sisa'},
      {name:'jangka_waktu',index:'jangka_waktu'},
      {name:'tanggal_jtempo',index:'tanggal_jtempo'},
    ],
    shrinkToFit: true,
    pager: "#plist485",
    viewrecords: true,
...
//  END
  ...
  $('#financing_type').change(function(){
      ...
      $('#previewpdf').click(function(){
		  ...
		  var site = '<?php echo site_url('laporan_to_pdf/export_list_jatuh_tempo'); ?>';
		  var conf = true;
		  ...
		  if(conf == true){
			  window.open(site+'/'+branch_code+'/'+financing_type+'/'+fa_code+'/'+cm_code+'/'+tanggal+'/'+tanggal2);
		  }
      });
      ...
      $('#previewxls').click(function(){
		  ...
		  var tanggal2 = $('#tanggal2').val();
		  var tanggal2 = datepicker_replace(tanggal2);
		  var site = '<?php echo site_url('laporan_to_excel/export_list_jatuh_tempo'); ?>';
		  var conf = true;
      ...
      $('#previewcsv').click(function(){
		  ...
		  var tanggal2 = $('#tanggal2').val();
		  var tanggal2 = datepicker_replace(tanggal2);
		  var site = '<?php echo site_url('laporan_to_csv/export_list_jatuh_tempo'); ?>';
		  var conf = true;
