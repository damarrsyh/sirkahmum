      ...
      <table id="filter-form">
         ...
         <tr>
            <td width="100" valign="top">Tanggal</td>
                <td valign="top">
                <input type="text" name="tanggal" id="from_date" tabindex="2" placeholder="dd/mm/yyyy" class="mask_date date-picker" value="<?php echo $current_date; ?>" maxlength="10" style="width:100px;padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;">
                sd
                <input type="text" name="tanggal2" id="thru_date" tabindex="2" placeholder="dd/mm/yyyy" class="mask_date date-picker" value="<?php echo $current_date; ?>" maxlength="10" style="width:100px;padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;">
            </td>
         </tr>
         <tr>
            <td></td>
            <td>
               ...
               <button class="green btn" id="previewtxt">Preview Txt</button>
            </td>
         </tr>
      </table>
   </form>
...
/* BEGIN SCRIPT */
   ...
   $("#filter").click(function(e){
      ...
      $.ajax({
         type: "POST",
         dataType: "json",
         url: site_url+"laporan/get_rekap_mutasi_gl",
         data: {
   ...
   $("#previewpdf").click(function(e){
      ...
      window.open(site_url+"laporan_to_pdf/rekap_mutasi_gl/"+from_date+"/"+thru_date+"/"+branch_code);
   ...
   $("#previewxls").click(function(e){
    e.preventDefault();
      ...
      var from_date = $("#from_date").val();
      var thru_date = $("#thru_date").val();
        window.open(site_url+"laporan_to_excel/rekap_mutasi_gl/"+from_date+"/"+thru_date+"/"+branch_code);
      
   });
   $("#previewtxt").click(function(e){
    e.preventDefault();
      var branch_code = $("#branch_code").val();
      var from_date = $("#from_date").val();
      var thru_date = $("#thru_date").val();
        window.open(site_url+"laporan/cetak_rekap_mutasi_gl_txt/"+from_date+"/"+thru_date+"/"+branch_code);
