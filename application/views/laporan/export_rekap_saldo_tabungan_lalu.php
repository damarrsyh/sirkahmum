...
<page>
      <div style="width:100%;">
        ...
        <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:16px;">
        Rekap Saldo Tabungan Bulan Lalu
        </div>
...
<table id="hor-minimalist-b" align="center">
    <tbody>
      <tr>
            ...
            <td class="anggota" style="width:120px;">Produk</td>
            <td class="jumlah" style="width:50px;">Jumlah</td>
            <td class="pokok" style="width:80px;">Nominal</td>
      </tr>
      <?php
      $no = 1;
      $total_anggota = 0;
    ...
    ?>      
      <tr class="value">
            ...
            <td class="val_pokok"><?php echo number_format($total_saldo,0,',','.');?></td>
      </tr>
    </tbody>
</table>
</page>