   ...
   <div class="portlet-body">
      <div class="clearfix">
         ...
         <form action="javascript:;">
            ...
            <table id="filter-form" class="col-md-6" style="margin-left: 500px; margin-top: -230px;">
               <tr>
                <td>Produk</td>
                <td>
                  <select name="product" class="chosen m-wrap" id="product">
                    <option value="" selected="selected">Pilih</option>
                    <option value="00000">SEMUA</option>
                    <?php foreach($product as $pro){ ?>
                    <option value="<?php echo $pro['product_code']; ?>"><?php echo $pro['product_name']; ?></option>
                    <?php } ?>
                  </select>
                </td>
               </tr>
               <tr>
                <td>Peruntukan</td>
                <td>
                  <select name="peruntukan" class="chosen m-wrap" id="peruntukan">
                    <option value="" selected="selected">Pilih</option>
                    <option value="00000">Semua</option>
               ...
               <tr>
                <td>Sektor</td>
                <td>
                  <select name="sektor" class="chosen m-wrap" id="sektor">
                    <option value="" selected="selected">Pilih</option>
                    <option value="00000">Semua</option>
...
// END
  ...
  $('#financing_type').change(function(){
      ...
      var kreditur = $('#kreditur').val();
		  ...
		  var site = '<?php echo site_url('laporan_to_excel/export_lap_droping_pembiayaan'); ?>';
      ...
      if(kreditur == ''){
        ...
        var conf = false;
		  ...
		  if(conf == true){
			  window.open(site+'/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code+'/'+financing_type+'/'+fa_code+'/'+peruntukan+'/'+sektor+'/'+product+'/'+kreditur);
		  }
	  });
      ...
      var kreditur = $('#kreditur').val();
		  ...
		  var tanggal2 = datepicker_replace(tanggal2);
		  var fa_code = $('#fa_code').val();
		  var site = '<?php echo site_url('laporan_to_pdf/export_lap_droping_pembiayaan'); ?>';
		  var peruntukan = $('#peruntukan').val();
		  var sektor = $('#sektor').val();
		  var conf = true;
      ...
      var kreditur = $('#kreditur').val();
		  ...
		  var tanggal2 = datepicker_replace(tanggal2);
		  var fa_code = $('#fa_code').val();
		  var site = '<?php echo site_url('laporan_to_csv/export_lap_droping_pembiayaan'); ?>';
		  var peruntukan = $("#peruntukan").val();
		  var sektor = $("#sektor").val();
		  var conf = true;
