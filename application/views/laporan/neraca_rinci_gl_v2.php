...
<div class="row-fluid">
   <div class="span12">
      ...
      <h3 class="form-section">
        LAPORAN NERACA RINCI<small></small>
      </h3>
      <!-- END PAGE TITLE-->
   </div>
</div>
...
/* BEGIN SCRIPT */
   ...
   $("#filter").live('click',function(e)
      {
        ...
        window.open('<?php echo site_url();?>laporan_to_pdf/export_neraca_rinci_gl_v2/'+branch_code+'/'+periode_bulan+'/'+periode_tahun+'/'+periode_hari);
      });
   ...
   $("#previewxls").click(function(e){
        ...
        var periode_bulan = $("#periode").val().substr(2,2);
        var periode_tahun = $("#periode").val().substr(4,4);
        window.open('<?php echo site_url();?>laporan_to_excel/export_neraca_rinci_gl_v2/'+branch_code+'/'+periode_bulan+'/'+periode_tahun+'/'+periode_hari);
   });
