...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Bagi Hasil</div>
      <div class="tools">
...
$("#result option","#dialog_kantor_cabang").live('dblclick',function(){
  ...
  $('#financing_type').change(function(){
      ...
      $('#previewxls').click(function(){
		  ...
		  var site = '<?php echo site_url('laporan_to_excel/export_lap_list_bagihasil'); ?>';
		  var conf = true;
      ...
      $('#previewpdf').click(function(){
		  ...
		  var fa_code = $('#fa_code').val();
		  var periode = $('#periode').val();
		  var site = '<?php echo site_url('laporan_to_pdf/export_lap_list_bagihasil'); ?>';
		  var conf = true;
      ...
      $('#previewcsv').click(function(){
		  ...
		  var fa_code = $('#fa_code').val();
		  var periode = $('#periode').val();
		  var site = '<?php echo site_url('laporan_to_csv/export_lap_list_bagihasil'); ?>';
		  var conf = true;
