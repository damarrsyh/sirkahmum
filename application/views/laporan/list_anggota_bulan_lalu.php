...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Saldo Anggota Bulan Lalu</div>
      <div class="tools">
...
var gridaja = function(){
	...
	jQuery('#list485').jqGrid({
		...
		postData: {
	  	...
	  	colNames:['Cif No','Nama','Majelis','Desa','Pembiayaan Pokok','Pembiayaan Margin','Wajib','Kelompok','Sukarela','Pokok','Margin','Catab','Tabber'],
	  	colModel:[
        ...
        {name:'saldo_catab', index:'saldo_catab'},
        {name:'saldo_tabber', index:'saldo_tabber'}
  ...
  $('#previewpdf').click(function(){
	  ...
	  var site = '<?php echo site_url('laporan_to_pdf/export_lap_list_anggota_bulan_lalu'); ?>';
	  ...
	  if(conf == true){
		  window.open(site+'/'+branch_code+'/'+fa_code+'/'+cm_code+'/'+hari+'/'+bulan+'/'+tahun);
	  }
  });
  ...
  $('#previewxls').click(function(){
	  ...
	  var cm_code = $('#cm_code').val();
	  var fa_code = $('#fa_code').val();
	  var site = '<?php echo site_url('laporan_to_excel/export_lap_list_anggota_bulan_lalu'); ?>';
	  var tanggal = $('#tanggal').val();
  ...
  $('#previewcsv').click(function(){
	  ...
	  var cm_code = $('#cm_code').val();
	  var fa_code = $('#fa_code').val();
	  var site = '<?php echo site_url('laporan_to_csv/export_lap_list_anggota_bulan_lalu'); ?>';
	  var tanggal = $('#tanggal').val();
