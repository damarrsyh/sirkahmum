...
<script type="text/javascript">
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        var filter = $("#filter").val();
          ...
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_outstanding_pembiayaan_sumber_dana/'+cabang);
          }
          else
          {
      ...
      $("#previewxls").click(function(e)
      {
        ...
        var filter = $("#filter").val();
          ...
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_outstanding_pembiayaan_sumber_dana/'+cabang);
          }
          else
          {
            alert("Parameter Kosong");
