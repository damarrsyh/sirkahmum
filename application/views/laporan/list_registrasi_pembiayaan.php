...
var showin = function(){
  ...
  jQuery("#list485").jqGrid({
    url: site_url+'laporan/jqgrid_list_registrasi_pembiayaan',
    //data: mydata,
    datatype: 'json',
    height: 'auto',
    autowidth: true,
    ...
    colNames:['No. Rekening','Nama','Majelis','Pembiayaan','Produk','Tanggal Registrasi','Plafon','Margin','Angs. Pokok','Angs. Margin','Angs. Catab','Total Angsuran','Jangka Waktu','Status'],
    colModel:[
      ...
      {name:'tanggal_registrasi',index:'tanggal_registrasi'},
      {name:'pokok',index:'pokok',align:'right'},
      {name:'margin',index:'margin',align:'right'},
      {name:'angsuran_pokok',index:'angsuran_pokok',align:'right'},
      {name:'angsuran_margin',index:'angsuran_margin',align:'right'},
      {name:'angsuran_catab',index:'angsuran_catab',align:'right'},
...
$("#result option","#dialog_kantor_cabang").live('dblclick',function(){
  ...
  $('#previewpdf').click(function(){
	  ...
	  var site = '<?php echo site_url('laporan_to_pdf/export_list_registrasi_pembiayaan'); ?>';
	  var conf = true;
  ...
  $('#previewxls').click(function(){
	  ...
	  var tanggal2 = datepicker_replace(tanggal2);
	  var fa_code = $('#fa_code').val();
	  var site = '<?php echo site_url('laporan_to_excel/export_list_registrasi_pembiayaan'); ?>';
	  var conf = true;
  ...
  $('#previewcsv').click(function(){
	  ...
	  var tanggal2 = datepicker_replace(tanggal2);
	  var fa_code = $('#fa_code').val();
	  var site = '<?php echo site_url('laporan_to_csv/export_list_registrasi_pembiayaan'); ?>';
	  var conf = true;
