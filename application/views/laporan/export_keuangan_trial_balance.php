...
<table id="hor-minimalist-b" style="padding-left:2px;border:solid 1px #262626 !important;">
    ...
    <?php
      foreach($result as $datas)
      {
        ...
        $total_mutasi_debet = $datas['total_mutasi_debet'];
        $total_mutasi_credit = $datas['total_mutasi_credit'];
        $saldo = $datas['saldo'];
    ?>
      <tr>
            <td class="nominal"><?php echo $account_code;?></td>
            <td class="konten"><?php echo $account_name;?></td>
            <td class="nominal"><?php echo number_format($saldo_awal,0,',','.');?></td>
            <td class="nominal"><?php echo number_format($total_mutasi_debet,0,',','.');?></td>
            <td class="nominal"><?php echo number_format($total_mutasi_credit,0,',','.');?></td>
