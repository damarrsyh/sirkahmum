...
<table id="hor-minimalist-b" align="center">
    <tbody>
        <tr>
          ...
          <td rowspan="2" class="title">Tanggal<br /> 
            Gabung</td>
		      <td rowspan="2" class="title">Tanggal<br />
	         Keluar</td>
           <td colspan="4" class="title">Saldo Simpanan </td>
		       <td colspan="2" class="title">Saldo Pembiayan </td>
        ...
        <?php 
          ...
          $total_saldo_tab_wajib += $data['saldo_simpanan_wajib'];
          $total_saldo_tab_kelompok += $data['saldo_tab_berencana'];
      ...
      <tr class="value">
        ...
        <td class="nominal"><?php echo number_format($data['saldo_simpanan_wajib'],0,',','.');?></td>
