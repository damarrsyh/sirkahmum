...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Outstanding Pembiayaan Bulan Lalu</div>
      <div class="tools">
   ...
   <div class="portlet-body">
      <div class="clearfix">
         ...
         <form action="javascript:;">
            ...
            <table id="filter-form" class="col-md-6" style="margin-left: 500px; margin-top: -225px;">
               <tr>
                  <td>Produk</td>
                  <td>
...
var gridaja = function(){
	...
	jQuery('#list485').jqGrid({
		url: site_url+'laporan/jqgrid_list_outstanding_pembiayaan_lalu',
		datatype: 'json',
		height: 'auto',
		autowidth: true,
		postData: {
        ...
        kreditur : function(){return $('#kreditur').val()},
	  	...
	  	colModel:[
			{name:'account_financing_no',index:'account_financing_no'},
		  	...
		  	{name:'freq_bayar_margin',index:'freq_bayar_saldo',align:'center'},
			{name:'jangka_waktu',index:'jangka_waktu',align:'center'},
			...
			{name:'saldo_catab',index:'saldo_catab',align:"right",formatter:"currency",formatoptions:{decimalSeparator:",",thousandsSeparator:".",decimalPlaces:0}},
  ...
  $('#previewpdf').click(function(){
    ...
    var kreditur = $('#kreditur').val();
	  var site = '<?php echo site_url('laporan_to_pdf/export_lap_list_outstanding_pembiayaan_lalu'); ?>';
    ...
    if(kreditur == ''){
	  ...
	  if(conf == true){
		  window.open(site+'/'+branch_code+'/'+financing_type+'/'+fa_code+'/'+cm_code+'/'+product+'/'+peruntukan+'/'+sektor+'/'+hari+'/'+bulan+'/'+tahun+'/'+kreditur);
	  }
  });
  ...
  $('#previewxls').click(function(){
    ...
    var kreditur = $('#kreditur').val();
	  var fa_code = $('#fa_code').val();
	  var site = '<?php echo site_url('laporan_to_excel/export_lap_list_outstanding_pembiayaan_lalu'); ?>';
	  var peruntukan = $('#peruntukan').val();
	  var sektor = $('#sektor').val();
	  var tanggal = $('#tanggal').val();
  ...
  $('#previewcsv').click(function(){
    ...
    var kreditur = $('#kreditur').val();
	  var fa_code = $('#fa_code').val();
	  var site = '<?php echo site_url('laporan_to_csv/export_lap_list_outstanding_pembiayaan_lalu'); ?>';
	  var peruntukan = $('#peruntukan').val();
	  var sektor = $('#sektor').val();
	  var tanggal = $('#tanggal').val();
