  ...
  <div class="portlet-body form">
     ...
     <form action="#" method="post" enctype="multipart/form-data" id="form_add" class="form-horizontal">
        ...
        <div class="form-actions">
           ...
           <button type="submit" id="export_pdf" class="btn green">Preview PDF</button>
           <button type="submit" id="export_excel" class="btn green">Preview XLS</button>
...
var showin = function(){
  ...
  jQuery("#list485").jqGrid({
    url: site_url+'laporan/jqgrid_list_saldo_anggota',
    //data: mydata,
    datatype: 'json',
    height: 'auto',
    autowidth: true,
    ...
    colNames:['ID','Nama','Majelis','Desa','LWK','Wajib','Kelompok','Sukarela','Taber', 'Pemb. Pokok','Pembi. Margin','Saldo Pokok','Saldo Margin'],
    colModel:[
      ...
      {name:'tabungan_berencana',index:'saldo_taber'},
...
$("#export_excel").click(function(e){
  ...
  cm_code = $("#cm_code").val();
  fa_code = $("#fa_code").val();
  window.open(site_url+"laporan_to_excel/export_list_saldo_anggota/"+branch_code+"/"+fa_code+"/"+cm_code);
});
...
$("#export_csv").click(function(e){
  ...
  cm_code = $("#cm_code").val();
  fa_code = $("#fa_code").val();
  window.open(site_url+"laporan_to_csv/export_list_saldo_anggota/"+branch_code+"/"+fa_code+"/"+cm_code);
});
...
$("#export_pdf").click(function(e){
  ...
  cm_code = $("#cm_code").val();
  fa_code = $("#fa_code").val();
  window.open(site_url+"laporan_to_pdf/export_list_saldo_anggota/"+branch_code+"/"+fa_code+"/"+cm_code);
});
