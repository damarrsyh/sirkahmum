...
<div class="portlet box blue">
  <div class="portlet-title">
     <div class="caption"><i class="icon-reorder"></i>LIST ANGGOTA KELUAR</div>
     <div class="tools">
     </div>
  </div>
...
var showin = function(){
  ...
  jQuery("#list485").jqGrid({
    url: site_url+'laporan/jqgrid_list_anggota_keluar',
    //data: mydata,
    datatype: 'json',
    height: 'auto',
    autowidth: true,
    ...
    colNames:['ID','Nama','Rembug Pusat','Tanggal Gabung','Tanggal Keluar','Alasan Keluar','Keterangan Keluar'],
    colModel:[
      ...
      {name:'alasan_keluar',index:'alasan_keluar'},
...
$("#export_excel").click(function(e){
  ...
  alasan = $("#alasan").val();
  window.open(site_url+"laporan_to_excel/export_list_anggota_keluar/"+branch_code+"/"+cm_code+"/"+tanggal+"/"+tanggal2+"/"+alasan+"/preview");
});
...
$("#export_csv").click(function(e){
  ...
  tanggal2 = $("#tanggal2").val().replace(/\//g,'');
  alasan = $("#alasan").val();
  window.open(site_url+"laporan_to_csv/export_list_anggota_keluar/"+branch_code+"/"+cm_code+"/"+tanggal+"/"+tanggal2+"/"+alasan+"/preview");
});
...
$("#export_pdf").click(function(e){
  ...
  tanggal = $("#tanggal").val().replace(/\//g,'');
  tanggal2 = $("#tanggal2").val().replace(/\//g,'');
  window.open(site_url+"laporan_to_pdf/export_list_anggota_keluar/"+branch_code+"/"+cm_code+"/"+tanggal+"/"+tanggal2);
});
