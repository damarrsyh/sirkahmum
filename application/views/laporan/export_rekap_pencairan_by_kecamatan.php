...
<page>
      <div style="width:100%;">
        ...
        <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:18px;">
        Rekap Pencairan Pembiayaan Berdasarkan Kecamatan
        </div>
...
<table id="hor-minimalist-b" align="center">
    <tbody>
      <tr>
            ...
            <td class="pokok" style="width:80px;">Kecamatan</td>
            <td class="pokok" style="width:70px;">Jumlah</td>
            <td class="pokok" style="width:80px;">Droping</td>
            <td class="pokok" style="width:70px;">% Jumlah</td>
            <td class="pokok" style="width:70px;">% Nominal</td>
      </tr>
      <?php
        $sum_anggota = 0;
        $sum_pokok = 0;
    ...
    ?>      
      <tr class="value">
            ...
            <td class="val_pokok"><?php echo number_format($total_droping,0,',','.');?></td>
      </tr>
    </tbody>
</table>
</page>