...
<div class="portlet box blue">
  <div class="portlet-title">
     <div class="caption"><i class="icon-reorder"></i>CASH FLOW TRANSAKSI REMBUG</div>
     <div class="tools">
...
$("#export_excel").click(function(e){
  ...
  window.open(site_url+"laporan_to_excel/export_cashflow_transaksi_rembug/"+branch_code+"/"+awal_trx_date+"/"+akhir_trx_date+"/"+fa_code+"/"+cm_code);
});
...
$("#export_pdf").click(function(e){
  ...
  awal_trx_date = datepicker_replace($("#awal_trx_date").val());
  akhir_trx_date = datepicker_replace($("#akhir_trx_date").val());
  window.open(site_url+"laporan_to_pdf/export_cashflow_transaksi_rembug/"+branch_code+"/"+awal_trx_date+"/"+akhir_trx_date+"/"+fa_code+"/"+cm_code);
});
