...
<table id="hor-minimalist-b" style="margin:0;" align="center">
  <thead>
    ...
    <tr class="value">
      ...
      <td style="padding:5px; font-size:10px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:center; white-space:normal; width:200px;"><?php echo $data['description'] ?></td>
      <td style="padding:5px; font-size:11px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:left;" align="right"><?php echo number_format($data['amount_debit'],0,',','.');?></td>
      <td style="padding:5px; font-size:11px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align:left;" align="right"><?php echo number_format($data['amount_credit'],0,',','.');?></td>
