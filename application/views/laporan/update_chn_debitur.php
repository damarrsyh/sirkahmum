...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Update Calon Debitur</div>
      <div class="tools">
...
<script type="text/javascript">
  ...
  $("#export_excel").on('submit',(function(e) {
    e.preventDefault();
    $.ajax({
          url: site_url+"laporan/imp_chn_debitur_update_excel",
      type: "POST",
...
var showin = function(){
  ...
  jQuery("#list485").jqGrid({
    url: site_url+'laporan/jqgrid_list_chn_debitur',
    //data: mydata,
...
// END
  ...
  $("#update").click(function(){
     ...
     $.ajax({
       type: "POST",
       url: site_url+"laporan/chn_debitur_update",
       dataType: "json",
