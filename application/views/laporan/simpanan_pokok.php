...
<div class="portlet box blue">
  <div class="portlet-title">
     <div class="caption"><i class="icon-reorder"></i>SIMPANAN POKOK</div>
     <div class="tools">
     </div>
  </div>
...
$("#export_excel").click(function(e){
  ...
  cm_code = $("#cm_code").val();
  window.open(site_url+"laporan_to_excel/export_simpanan_pokok/"+branch_code+"/"+cm_code);
});
...
$("#export_pdf").click(function(e){
  ...
  branch_code = $("#branch_code").val();
  cm_code = $("#cm_code").val();
  window.open(site_url+"laporan_to_pdf/export_simpanan_pokok/"+branch_code+"/"+cm_code);
});
