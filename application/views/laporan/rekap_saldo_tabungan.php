...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Rekap Saldo Tabungan</div>
      <div class="tools">
  ...
  $("#result option:selected").live('dblclick',function(){
    $("#select_cabang").trigger('click');
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_saldo_tabungan/'+cabang);
      });
      ...
      $("#previewxls").click(function(e)
      {
        e.preventDefault();
        var cabang    = $("#cabang").val();
        window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_saldo_tabungan/'+cabang);
      });
