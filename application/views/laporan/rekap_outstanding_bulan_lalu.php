...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Rekap Outstanding Piutang Bulan Lalu</div>
      <div class="tools">
      ...
      <div class="clearfix">
            <!-- BEGIN FILTER-->
              <table id="sorting_saldo">
               ...
               <tr>
                 <td>Tanggal</td>
                 <td><select name="tanggal" id="tanggal" class="m-wrap chosen">
                 	<option value="" selected="selected">Pilih</option>
                    <?php
...
<script type="text/javascript">
      ...
      $("#previewpdf").click(function(e){
		  ...
		  if(conf == true){
			  if(filter == '0'){
				  var site = '<?php echo site_url('laporan_to_pdf/export_rekap_outstanding_pembiayaan_cabang_lalu'); ?>';
			  } else if(filter == '1'){
				  var site = '<?php echo site_url('laporan_to_pdf/export_rekap_outstanding_pembiayaan_rembug_lalu');?>';
			  } else if(filter == '2'){
				  var site = '<?php echo site_url('laporan_to_pdf/export_rekap_outstanding_pembiayaan_petugas_lalu');?>';
			  } else if(filter == '3'){
				  var site = '<?php echo site_url('laporan_to_pdf/export_rekap_outstanding_pembiayaan_produk_lalu');?>';
			  } else if(filter == '4'){
				  var site = '<?php echo site_url('laporan_to_pdf/export_rekap_outstanding_pembiayaan_peruntukan_lalu');?>';
			  } else if(filter == '5'){
				  var site = '<?php echo site_url('laporan_to_pdf/export_rekap_outstanding_pembiayaan_sektor_usaha_lalu');?>';
			  } else {
				  var site = '<?php echo site_url('laporan_to_pdf/export_rekap_outstanding_pembiayaan_sumber_dana_lalu');?>';
			  }

			  window.open(site+'/'+cabang+'/'+hari+'/'+bulan+'/'+tahun);
		  }
      });
      ...
      $("#previewxls").click(function(e){
		  ...
		  if(conf == true){
			  if(filter == '0'){
				  var site = '<?php echo site_url('laporan_to_excel/export_rekap_outstanding_pembiayaan_cabang_lalu'); ?>';
			  } else if(filter == '1'){
				  var site = '<?php echo site_url('laporan_to_excel/export_rekap_outstanding_pembiayaan_rembug_lalu');?>';
			  } else if(filter == '2'){
				  var site = '<?php echo site_url('laporan_to_excel/export_rekap_outstanding_pembiayaan_petugas_lalu');?>';
			  } else if(filter == '3'){
				  var site = '<?php echo site_url('laporan_to_excel/export_rekap_outstanding_pembiayaan_produk_lalu');?>';
			  } else if(filter == '4'){
				  var site = '<?php echo site_url('laporan_to_excel/export_rekap_outstanding_pembiayaan_peruntukan_lalu');?>';
			  } else if(filter == '5'){
				  var site = '<?php echo site_url('laporan_to_excel/export_rekap_outstanding_pembiayaan_sektor_usaha_lalu');?>';
			  } else {
				  var site = '<?php echo site_url('laporan_to_excel/export_rekap_outstanding_pembiayaan_sumber_dana_lalu');?>';
			  }
