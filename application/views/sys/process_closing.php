...
<div class="row-fluid">
   <div class="span12">
      ...
      <h3 class="form-section">
        Proses Akhir Bulan <small>Regis Closing</small>
      </h3>
      <!-- END PAGE TITLE-->
   </div>
</div>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Regis Closing</div>
      <div class="tools">
   ...
   <div class="portlet-body form">
      <div class="clearfix">
         <!-- BEGIN FILTER FORM -->
         <form class="form-horizontal" id="closing_transaction_process" method="post" action="<?php echo site_url('sys/regis_closing_process'); ?>">
            <?php
            echo $unverifieds;
            ?>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <!-- <input type="hidden" name="periode" id="periode" value="<?php echo date("d/m/Y",strtotime($akhir));?>"> -->
            ...
            <div class="form-actions">
              ...
              <a href="javascript:void(0);" class="btn grey">Regis Closing</a>
              <?php }else{ ?>
              <button type="submit" id="proses" class="btn green">Regis Closing</button>
              <?php } ?>
            </div>
         </form>
          <!-- END FILTER-->
