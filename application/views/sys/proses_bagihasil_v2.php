...
<script type="text/javascript">
   jQuery(document).ready(function() {    
      ...
      $("#btn_view").click(function(){
        ...
        if (bValid==false){
          ...
          $.ajax({
            type:"POST",
            async:true,
            url:site_url+'sys/get_data_bahas_v2',
            dataType:'json',
            data:{
            ...
            success: function(response){
              ...
              generate_product_deposito_v2(response.dana_pihak_ke3,response.porsi_pendapatan_dp3)
              generate_product_mudharabah_v2(response.dana_pihak_ke3,response.porsi_pendapatan_dp3)
              generate_product_wadiah_v2()
              generate_product_tabungan_anggota_v2()
      ...
      function generate_product_deposito_v2(dana_pihak_ke3,porsi_pendapatan_dp3)
      {      
        ...
        $.ajax({
          type:"POST",
          async:false,
          url:site_url+'sys/generate_product_deposito_v2',
          dataType:'html',
          data:{
            from_date:from_date
            ,thru_date:thru_date
      ...
      function generate_product_mudharabah_v2(dana_pihak_ke3,porsi_pendapatan_dp3)
      {                  
        from_date=$("#from_date").val();            
        thru_date=$("#thru_date").val();   
        $.ajax({
          type:"POST",
          async:false,
          url:site_url+'sys/generate_product_mudharabah_v2',
          dataType:'html',
          data:{
            from_date:from_date
            ,thru_date:thru_date
      ...
      function generate_product_wadiah_v2()
      {                  
        from_date=$("#from_date").val();            
        thru_date=$("#thru_date").val();   
          $.ajax({
            type:"POST",
            async:false,
            url:site_url+'sys/generate_product_wadiah_v2',
            dataType:'html',
            data:{
              from_date:from_date
              ,thru_date:thru_date
      ...
      {             
        ...
        $.ajax({
          type:"POST",
          async:false,
          url:site_url+'sys/generate_product_tabungan_anggota_v2',
          dataType:'html',
          data:{
            from_date:from_date
            ,thru_date:thru_date
