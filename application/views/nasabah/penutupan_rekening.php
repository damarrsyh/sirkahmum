...
<div class="row-fluid">
   <div class="span12">
      ...
      <!-- BEGIN PAGE TITLE & BREADCRUMB-->
		<h3 class="page-title">
			Penutupan Rekening Tabungan<small> Penutupan Rekening Tabungan</small>
		</h3>
		<ul class="breadcrumb">
			<li>
				<i class="icon-home"></i>
         ...
         <li><a href="#">Rekening Nasabah</a><i class="icon-angle-right"></i></li>
			<li><a href="#">Penutupan Rekening Tabungan</a></li>	
		</ul>
...
<div id="add">
   ...
   <div class="portlet box green">
      <div class="portlet-title">
         <div class="caption"><i class="icon-reorder"></i>Penutupan Rekening Tabungan</div>
         <div class="tools">
      ...
      <div class="portlet-body form">
         <!-- BEGIN FORM-->
         <form action="<?php echo site_url('rekening_nasabah/proses_penutupan_rek_tabungan'); ?>" method="post" enctype="multipart/form-data" id="form_add" class="form-horizontal">
            ...
            <div class="alert alert-success hide">
               <button class="close" data-dismiss="alert"></button>
               Penutupan Rekening Tabungan Berhasil Diproses !
            </div>
           </br>
           <div class="control-group">
            ...
            <div class="control-group">
               <label class="control-label">Saldo Ditahan</label>
               <div class="controls">
                <div class="input-prepend input-append">
                   <span class="add-on">Rp</span>
                      <input name="saldo_ditahan" id="saldo_ditahan" type="text" class="m-wrap mask-money" readonly="readonly" style="background-color:#eee;width:120px;"/>
                   <span class="add-on">,00</span>
                  </div>
               </div>
            </div>  
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            // }else{
               ...
               var saldo_rekening_ok = response.saldo_memo;
               $("#saldo_rekening").val(number_format(saldo_rekening_ok),0,',','.');
               var saldo_minimal_ok = response.saldo_minimal;
               $("#saldo_minimal").val(number_format(saldo_minimal_ok),0,',','.');
               var saldo_hold_ok = response.amount;
               $("#saldo_ditahan").val(number_format(saldo_hold_ok),0,',','.');
               var saldo_efektif = saldo_rekening_ok-saldo_hold_ok-saldo_minimal_ok;
  ...
  $("#result option").live('dblclick',function(){
        ...
        $("#cif_type","#form_add").change(function(){
          ...
          if(type=="0"){
            ...
            $("p#pcm").hide().val('');
			  ...
			  $.ajax({
				type: "POST",
				url: site_url+"cif/search_cif_for_tutup_tabungan",
   ...
   $(function(){
      $("#saldo_ditahan").change(function(){
            var saldo_rekening = parseFloat($("#saldo_rekening").val());
            console.log(saldo_rekening);  
            var saldo_minimal = parseFloat($("#saldo_minimal").val());  
            console.log(saldo_minimal);
            var saldo_ditahan = parseFloat($("#saldo_ditahan").val());
