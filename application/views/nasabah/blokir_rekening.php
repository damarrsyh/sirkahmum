...
<div class="row-fluid">
   <div class="span12">
      ...
      <!-- BEGIN PAGE TITLE & BREADCRUMB-->
		<h3 class="page-title">
			Blokir Rekening Tabungan<small> Blokir Rekening Tabungan</small>
		</h3>
		<ul class="breadcrumb">
			<li>
				<i class="icon-home"></i>
         ...
         <li><a href="#">Rekening Nasabah</a><i class="icon-angle-right"></i></li>
			<li><a href="#">Blokir Rekening Tabungan</a></li>	
		</ul>
...
<div id="add">
   ...
   <div class="portlet box green">
      <div class="portlet-title">
         <div class="caption"><i class="icon-reorder"></i>Blokir Rekening Tabungan</div>
         <div class="tools">
      ...
      <div class="portlet-body form">
         <!-- BEGIN FORM-->
         <form action="<?php echo site_url('rekening_nasabah/proses_blokir_rek_tabungan'); ?>" method="post" enctype="multipart/form-data" id="form_add" class="form-horizontal">
            ...
            <div class="alert alert-success hide">
               <button class="close" data-dismiss="alert"></button>
               Blokir Rekening Tabungan Berhasil Diproses !
            </div>
           </br>
           <div class="control-group">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input name="nama_lengkap" id="nama_lengkap" type="text" class="medium m-wrap" readonly="readonly" style="background-color:#eee;"/>
               </div>
            </div>
            <div class="control-group">
               <label class="control-label">Produk</label>
               <div class="controls">
                  <input name="product" id="product" type="text" class="medium m-wrap" readonly="readonly" style="background-color:#eee;"/>
               </div>
            </div>
            <!-- <div class="control-group">
               <label class="control-label">Nama</label>
               <div class="controls">
                  <input name="nama" id="nama" type="text" class="medium m-wrap" readonly="readonly"/>
               </div>
            </div> -->
            <div class="control-group">
               ...
               <div class="controls">
                <div class="input-prepend input-append">
                   <span class="add-on">Rp</span>
                    <input name="saldo_rekening" id="saldo_rekening" type="text" class="m-wrap mask-money" readonly="readonly" style="background-color:#eee;width:120px;"/>
            ...
            <div class="control-group hide">
               ...
               <div class="controls">
                <div class="input-prepend input-append">
                   <span class="add-on">Rp</span>
                    <input name="saldo_minimal" id="saldo_minimal" type="text" class="m-wrap mask-money" readonly="readonly" style="background-color:#eee;width:120px;"/>
                   <span class="add-on">,00</span>
                </div>  
               </div>
            </div>
            <div class="control-group">
               ...
               <div class="controls">
                  <select id="status_blokir" name="status_blokir" class="m-wrap">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                <div class="input-prepend input-append">
                   <span class="add-on">Rp</span>
                    <input name="saldo_ditahan" id="saldo_ditahan" data-required="1" type="text" class="m-wrap mask-money" style="width:120px;" value="0" />
                   <span class="add-on">,00</span>
                </div>  
               </div>
            </div>  
            <div class="control-group">
               ...
               <div class="controls">
                <div class="input-prepend input-append">
                   <span class="add-on">Rp</span>
                     <input name="saldo_efektif" id="saldo_efektif" type="text" class="m-wrap mask-money" readonly="readonly" style="background-color:#eee;width:120px;"/>
                   <span class="add-on">,00</span>
                </div>  
               </div>
            </div>              
           <div class="control-group ">
              ...
              <div class="controls">
                 <textarea name="alasan" id="alasan" class="medium m-wrap"/></textarea>
              </div>
           </div>    
...
$(function(){
  ...
  $("#status_blokir").change(function(){
    status_blokir=$(this).val();
    if(status_blokir==1){
      // $("#saldo_ditahan").parent().parent().parent().hide();
      $("#saldo_ditahan").attr('readonly',true).css('backgroundColor','#EEEEEE').val(0);
    }else{
      // $("#saldo_ditahan").parent().parent().parent().show();
      $("#saldo_ditahan").attr('readonly',false).css('backgroundColor','#FFFFFF').val(0);
    }
  })
  ...
  $("#select").click(function(){
      ...
      $.ajax({
        ...
        url: site_url+"rekening_nasabah/get_cif_by_account_saving_no",
  ...
  $("#result option").live('dblclick',function(){
    $("#select").trigger('click');
        ...
        $("#cif_type","#form_add").change(function(){
          ...
          if(type=="0"){
            ...
            $.ajax({
              type: "POST",
              url: site_url+"cif/search_cif_for_blokir_tabungan",
   ...
   $(function(){
      $("#saldo_ditahan").change(function(){
            ...
            // var saldo_efektif = parseFloat(saldo_rekening)+parseFloat(saldo_ditahan)+parseFloat(saldo_minimal);
            var saldo_efektif = parseFloat(saldo_rekening)-parseFloat(saldo_ditahan);
