          ...
          <h3 class="form-section">Pencairan Rekening Tabungan Berencana</h3> 
           ...
           <!--  <div class="control-group">
            ...
            <div class="control-group">
               <label class="control-label">Tanggal Transaksi<span class="required">*</span></label>
               <div class="controls">
                  <input type="text" class="m-wrap normal date-picker" placeholder="dd/mm/yyyy" name="tanggal" id="tanggal" value="<?php echo date('d/m/Y') ?>">
                </div>
            </div>
            <div class="control-group">
               <label class="control-label">Bonus<span class="required">*</span></label>
               <div class="controls">
                   <div class="input-prepend input-append">
                     <span class="add-on">Rp</span>
                     <input type="text" class="m-wrap mask-money" readonly="readonly" style="width:120px;background-color:#eee;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" name="bonus_bagihasil" id="bonus_bagihasil" maxlength="12">
                     <span class="add-on">,00</span>
                   </div>
                 </div>
            </div>
      ...
      $("#keyword").on('keypress',function(e){
        if(e.which==13){
         // type = $("#cif_type","#form_add").val();
          ...
          $.ajax({
            type: "POST",
            url: site_url+"transaction/search_rekening_tabungan_pencairan",
